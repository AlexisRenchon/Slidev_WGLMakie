...
var Dt = E((Ad, fi) => {
  var di = ce(), ih = di({}.toString), ah = di("".slice);
...
var Fi = E((Nd, Di) => {
  var ki = J(), Ts = Ci(), Si = ki.process, wi = ki.Deno, Ii = Si && Si.versions || wi && wi.version, Ni = Ii && Ii.v8, fe, Lt;
  Ni && (fe = Ni.split("."), Lt = fe[0] > 0 && fe[0] < 4 ? 1 : +(fe[0] + fe[1]));
  !Lt && Ts && (fe = Ts.match(/Edge\/(\d+)/), (!fe || fe[1] >= 74) && (fe = Ts.match(/Chrome\/(\d+)/), fe && (Lt = +fe[1])));
  Di.exports = Lt;
});
var vs = E((kd, Oi) => {
  var Li = Fi(), Ah = ve();
...
var $i = E((Bd, Hi) => {
  ...
  Hi.exports = function(l, c) {
    var d, f;
    if (c === "string" && Ss(d = l.toString) && !ws(f = Cs(d, l)) || Ss(d = l.valueOf) && !ws(f = Cs(d, l)) || c !== "string" && Ss(d = l.toString) && !ws(f = Cs(d, l)))
      return f;
...
var Is = E((qd, Yi) => {
  ...
  })("versions", []).push({ version: "3.22.2", mode: Uh ? "pure" : "global", copyright: "\xA9 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.22.2/LICENSE", source: "https://github.com/zloirock/core-js" });
});
var Ns = E((Ud, Qi) => {
...
var Ne = E((Hd, Zi) => {
  ...
  Zi.exports = Object.hasOwn || function(c, d) {
    return Wh(Kh(c), d);
  };
});
var ks = E(($d, ea) => {
...
var ha = E((Vd, la) => {
  ...
  la.exports = function(l, c) {
    ...
    var d = iu(l, lu), f;
    if (d) {
      if (c === void 0 && (c = "default"), f = ru(d, l, c), !na(f) || oa(f))
        return f;
...
var Ls = E((Gd, fa) => {
  var du = _e(), fu = ve(), mu = da();
  fa.exports = !du && !fu(function() {
...
var qs = E((va) => {
  ...
  va.f = ku ? Fu ? function(c, d, f) {
    if (_t(c), d = Ta(d), _t(f), typeof c == "function" && d === "prototype" && "value" in f && js in f && !f[js]) {
      var x = Ou(c, d);
      x && x[js] && (c[d] = f.value, f = { configurable: Rs in f ? f[Rs] : x[Rs], enumerable: _s in f ? f[_s] : x[_s], writable: false });
    }
    return Bs(c, d, f);
  } : Bs : function(c, d, f) {
    if (_t(c), d = Ta(d), _t(f), Du)
      try {
        return Bs(c, d, f);
      } catch {
      }
...
var Rt = E((Zd, Ea) => {
  ...
  Ea.exports = Mu ? function(l, c, d) {
    return Bu.f(l, c, _u(1, d));
  } : function(l, c, d) {
    return l[c] = d, l;
  };
});
...
var Va = E((of, za) => {
  ...
  (za.exports = function(l, c, d, f) {
    var x = f ? !!f.unsafe : false, g = f ? !!f.enumerable : false, A = f ? !!f.noTargetGet : false, T = f && f.name !== void 0 ? f.name : c, S;
    if (Ua(d) && (String(T).slice(0, 7) === "Symbol(" && (T = "[" + String(T).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!ac(d, "name") || lc && d.name !== T) && Ha(d, "name", T), S = uc(d), S.source || (S.source = cc.join(typeof T == "string" ? T : ""))), l === ic) {
      g ? l[c] = d : nc(c, d);
      return;
    } else
...
var Xs = E((lf, Ka) => {
  var pc = Math.ceil, dc = Math.floor;
  Ka.exports = function(l) {
    var c = +l;
    return c !== c || c === 0 ? 0 : (c > 0 ? dc : pc)(c);
  };
});
var Ga = E((hf, Wa) => {
  var fc = Xs(), mc = Math.max, yc = Math.min;
  Wa.exports = function(l, c) {
    var d = fc(l);
    return d < 0 ? mc(d + c, 0) : yc(d, c);
  };
});
var Xa = E((uf, Ja) => {
...
var rn = E((df, sn) => {
  ...
  sn.exports = function(l, c) {
    var d = bc(l), f = 0, x = [], g;
    for (g in d)
      !Ys(Sc, g) && Ys(d, g) && tn(x, g);
    for (; c.length > f; )
      Ys(d, g = c[f++]) && (~Cc(x, g) || tn(x, g));
    return x;
  };
});
var nn = E((ff, an) => {
...
var pn = E((xf, cn) => {
  ...
  cn.exports = kc("Reflect", "ownKeys") || function(c) {
    var d = Fc.f(Oc(c)), f = Lc.f;
    return f ? Mc(d, f(c)) : d;
  };
});
var mn = E((gf, fn) => {
  var dn = Ne(), Bc = pn(), _c = Os(), Rc = qs();
  fn.exports = function(l, c, d) {
    for (var f = Bc(c), x = Rc.f, g = _c.f, A = 0; A < f.length; A++) {
      var T = f[A];
      !dn(l, T) && !(d && dn(d, T)) && x(l, T, g(c, T));
    }
  };
});
var xn = E((Pf, yn) => {
  var jc = ve(), qc = pe(), Uc = /#|\.prototype\./, ht = function(l, c) {
    var d = $c[Hc(l)];
    return d == Vc ? true : d == zc ? false : qc(c) ? jc(c) : !!c;
...
var Zs = E((Af, gn) => {
  ...
  gn.exports = function(l, c) {
    var d = l.target, f = l.global, x = l.stat, g, A, T, S, O, I;
    if (f ? A = Qs : x ? A = Qs[d] || Jc(d, {}) : A = (Qs[d] || {}).prototype, A)
      for (T in c) {
        if (O = c[T], l.noTargetGet ? (I = Kc(A, T), S = I && I.value) : S = A[T], g = Yc(f ? T : d + (x ? "." : "#") + T, l.forced), !g && S !== void 0) {
...
var Sn = E((Cf, Cn) => {
  "use strict";
  var ip = J(), ap = er(), np = Ht(), op = En(), lp = ip.TypeError, bn = function(l, c, d, f, x, g, A, T) {
    for (var S = x, O = 0, I = A ? op(A, T) : false, C, F; O < f; ) {
      if (O in d) {
        if (C = I ? I(d[O], O, c) : d[O], g > 0 && ap(C))
          F = np(C), S = bn(l, c, C, F, S, g - 1) - 1;
        else {
...
var Dn = E((wf, kn) => {
  var cp = J(), pp = Nn(), dp = pe(), $t = Dt(), fp = ot(), mp = fp("toStringTag"), yp = cp.Object, xp = $t(function() {
    return arguments;
  ...
  kn.exports = pp ? $t : function(l) {
    var c, d, f;
    return l === void 0 ? "Undefined" : l === null ? "Null" : typeof (d = gp(c = yp(l), mp)) == "string" ? d : xp ? $t(c) : (f = $t(c)) == "Object" && dp(c.callee) ? "Arguments" : f;
  };
});
var _n = E((If, Bn) => {
...
Lp({ target: "Array", proto: true }, { flatMap: function(c) {
  var d = Bp(this), f = _p(d), x;
  return Mp(c), x = Rp(d, 0), x.length = Op(x, d, d, f, 0, 1, c, arguments.length > 1 ? arguments[1] : void 0), x;
} });
...
var Up = (l, c) => {
  for (var d in c)
    ar(l, d, { get: c[d], enumerable: true });
};
var Hp = (l, c, d, f) => {
  if (c && typeof c == "object" || typeof c == "function")
    for (let x of nr(c))
      !qp.call(l, x) && x !== d && ar(l, x, { get: () => c[x], enumerable: !(f = jp(c, x)) || f.enumerable });
  return l;
};
...
var Vp = W({ "src/utils/text/skip-inline-comment.js"(l, c) {
  ...
  function d(f, x) {
    ...
    if (f.charAt(x) === "/" && f.charAt(x + 1) === "*") {
      for (let g = x + 2; g < f.length; ++g)
        if (f.charAt(g) === "*" && f.charAt(g + 1) === "/")
          return g + 2;
    }
    return x;
  }
...
var Kn = W({ "src/utils/text/skip.js"(l, c) {
  ...
  function d(T) {
    return (S, O, I) => {
      ...
      return _ === -1 || _ === F ? _ : false;
    };
  }
  var f = d(/\s/), x = d(" 	"), g = d(",; 	"), A = d(/[^\n\r]/);
  c.exports = { skipWhitespace: f, skipSpaces: x, skipToLineEnd: g, skipEverythingButNewLine: A };
} });
var Wp = W({ "src/utils/text/skip-trailing-comment.js"(l, c) {
  "use strict";
  K();
  var { skipEverythingButNewLine: d } = Kn();
  function f(x, g) {
    return g === false ? false : x.charAt(g) === "/" && x.charAt(g + 1) === "/" ? d(x, g) : g;
  }
  c.exports = f;
} });
var Gp = W({ "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(l, c) {
  "use strict";
  K();
  var d = Vp(), f = Kp(), x = Wp(), { skipSpaces: g } = Kn();
  function A(T, S) {
    let O = null, I = S;
    for (; I !== O; )
      O = I, I = g(T, I), I = d(T, I), I = x(T, I), I = f(T, I);
    return I;
  }
  c.exports = A;
} });
...
function Gn() {
  if (typeof zt > "u") {
    var l = new ArrayBuffer(2), c = new Uint8Array(l), d = new Uint16Array(l);
    if (c[0] = 1, c[1] = 2, d[0] === 258)
      zt = "BE";
    else if (d[0] === 513)
      zt = "LE";
    else
...
var ed = W({ "node_modules/jest-docblock/build/index.js"(l) {
  "use strict";
  K(), Object.defineProperty(l, "__esModule", { value: true }), l.extract = _, l.parse = $, l.parseWithComments = X, l.print = L, l.strip = N;
  function c() {
    let h = Qp();
    return c = function() {
      return h;
  ...
  function X(h) {
    ...
    for (; te = I.exec(h); ) {
      ...
      typeof Z[te[1]] == "string" || Array.isArray(Z[te[1]]) ? Z[te[1]] = F.concat(Z[te[1]], U) : Z[te[1]] = U;
    }
    return { comments: Ee, pragmas: Z };
  }
  function L(h) {
    let { comments: Y = "", pragmas: oe = {} } = h, Z = (0, d().default)(Y) || c().EOL, Ee = "/**", te = " *", U = " */", M = Object.keys(oe), v = M.map((V) => R(V, oe[V])).reduce((V, Q) => V.concat(Q), []).map((V) => `${te} ${V}${Z}`).join("");
    if (!Y) {
      if (M.length === 0)
        return "";
      if (M.length === 1 && !Array.isArray(oe[M[0]])) {
        let V = oe[M[0]];
        return `${Ee} ${R(M[0], V)[0]}${U}`;
      }
    }
  ...
  function R(h, Y) {
    return F.concat(Y).map((oe) => `@${h} ${oe}`.trim());
  }
} });
var td = W({ "src/common/end-of-line.js"(l, c) {
  "use strict";
  K();
  function d(A) {
    let T = A.indexOf("\r");
...
`);
  ...
  c.exports = { guessEndOfLine: d, convertEndOfLineToChars: f, countEndOfLineChars: x, normalizeEndOfLine: g };
} });
var sd = W({ "src/language-js/pragma.js"(l, c) {
  "use strict";
  K();
  var { parseWithComments: d, strip: f, extract: x, print: g } = ed(), { normalizeEndOfLine: A } = td(), T = Vn();
  function S(C) {
    let F = T(C);
    F && (C = C.slice(F.length + 1));
    let _ = x(C), { pragmas: N, comments: $ } = d(_);
    return { shebang: F, text: C, pragmas: N, comments: $ };
  }
  function O(C) {
    let F = Object.keys(S(C).pragmas);
    return F.includes("prettier") || F.includes("format");
  }
  function I(C) {
    let { shebang: F, text: _, pragmas: N, comments: $ } = S(C), X = f(_), L = g({ pragmas: Object.assign({ format: "" }, N), comments: $.trimStart() });
    return (F ? `${F}
` : "") + A(L) + (X.startsWith(`
`) ? `
` : `
...
var no = W({ "src/language-js/loc.js"(l, c) {
  ...
  function f(S) {
    var O, I;
    let C = S.range ? S.range[0] : S.start, F = (O = (I = S.declaration) === null || I === void 0 ? void 0 : I.decorators) !== null && O !== void 0 ? O : S.decorators;
    return d(F) ? Math.min(f(F[0]), C) : C;
  }
  function x(S) {
  ...
  function g(S, O) {
    let I = f(S);
    return Number.isInteger(I) && I === f(O);
  }
  function A(S, O) {
    let I = x(S);
  ...
  c.exports = { locStart: f, locEnd: x, hasSameLocStart: g, hasSameLoc: T };
} });
var oo = W({ "src/language-js/parse/utils/create-parser.js"(l, c) {
  "use strict";
  K();
  var { hasPragma: d } = sd(), { locStart: f, locEnd: x } = no();
  function g(A) {
    return A = typeof A == "function" ? { parse: A } : A, Object.assign({ astFormat: "estree", hasPragma: d, locStart: f, locEnd: x }, A);
  }
  c.exports = g;
} });
var lr = W({ "src/common/parser-create-error.js"(l, c) {
  ...
  K();
  function d(f, x) {
    let g = new SyntaxError(f + " (" + x.start.line + ":" + x.start.column + ")");
    return g.loc = x, g;
  }
  c.exports = d;
} });
var lo = W({ "src/language-js/parse/utils/create-babel-parse-error.js"(l, c) {
  ...
  function f(x) {
    ...
    return d(g.replace(/ \(.*\)/, ""), { start: { line: A ? A.line : 0, column: A ? A.column + 1 : 0 } });
  }
  c.exports = f;
} });
var rd = W({ "src/language-js/utils/is-ts-keyword-type.js"(l, c) {
  "use strict";
  K();
  function d(f) {
    let { type: x } = f;
...
var id = W({ "src/language-js/utils/is-block-comment.js"(l, c) {
  "use strict";
  K();
  var d = /* @__PURE__ */ new Set(["Block", "CommentBlock", "MultiLine"]), f = (x) => d.has(x == null ? void 0 : x.type);
  c.exports = f;
} });
var ad = W({ "src/language-js/utils/is-type-cast-comment.js"(l, c) {
  "use strict";
  K();
  var d = id();
  function f(x) {
    return d(x) && x.value[0] === "*" && /@type\b/.test(x.value);
  }
  c.exports = f;
} });
var nd = W({ "src/utils/get-last.js"(l, c) {
  "use strict";
  K();
...
var uo = W({ "src/language-js/parse/postprocess/throw-syntax-error.js"(l, c) {
  ...
  function f(x, g) {
    ...
    throw d(g, { start: { line: A.line, column: A.column + 1 }, end: { line: T.line, column: T.column + 1 } });
  }
  c.exports = f;
} });
var od = W({ "src/language-js/parse/postprocess/typescript.js"(l, c) {
  "use strict";
  K();
  var d = or(), f = ho(), x = uo(), g = { AbstractKeyword: 126, SourceFile: 308, PropertyDeclaration: 169 };
  function A(I) {
  ...
  function T(I) {
    ...
    if (!d(C))
      return;
    let [{ expression: F }] = C, _ = A(F), [N, $] = [F.pos, F.end].map((X) => {
      let { line: L, character: R } = _.getLineAndCharacterOfPosition(X);
      return { line: L + 1, column: R };
    });
    x({ loc: { start: N, end: $ } }, "Decorators are not valid here.");
  }
  function S(I, C) {
    I.kind !== g.PropertyDeclaration || I.modifiers && !I.modifiers.some((F) => F.kind === g.AbstractKeyword) || I.initializer && C.value === null && x(C, "Abstract property cannot have an initializer");
  }
  function O(I, C) {
    let { esTreeNodeToTSNodeMap: F, tsNodeToESTreeNodeMap: _ } = C.tsParseResult;
    f(I, (N) => {
      let $ = F.get(N);
      if (!$)
        return;
...
var ld = W({ "src/language-js/parse/postprocess/index.js"(l, c) {
  "use strict";
  K();
  var { locStart: d, locEnd: f } = no(), x = rd(), g = ad(), A = nd(), T = ho(), { throwErrorForInvalidNodes: S } = od(), O = uo();
  function I(N, $) {
    if ($.parser === "typescript" && /@|abstract/.test($.originalText) && S(N, $), $.parser !== "typescript" && $.parser !== "flow" && $.parser !== "acorn" && $.parser !== "espree" && $.parser !== "meriyah") {
      ...
      N = T(N, (R) => {
        R.leadingComments && R.leadingComments.some(g) && L.add(d(R));
      }), N = T(N, (R) => {
        if (R.type === "ParenthesizedExpression") {
          let { expression: h } = R;
          if (h.type === "TypeCastExpression")
            return h.range = R.range, h;
          let Y = d(R);
          if (!L.has(Y))
    ...
    return N = T(N, (L) => {
      switch (L.type) {
        ...
        case "VariableDeclaration": {
          let R = A(L.declarations);
          R && R.init && X(L, R);
          break;
        }
        case "TSParenthesizedType":
          return x(L.typeAnnotation) || L.typeAnnotation.type === "TSThisType" || (L.typeAnnotation.range = [d(L), f(L)]), L.typeAnnotation;
        case "TSTypeParameter":
          if (typeof L.name == "string") {
            let R = d(L);
            L.name = { type: "Identifier", name: L.name, range: [R, R + L.name.length] };
          }
          break;
        case "ObjectExpression":
          if ($.parser === "typescript") {
            let R = L.properties.find((h) => h.type === "Property" && h.value.type === "TSEmptyBodyFunctionExpression");
            R && O(R.value, "Unexpected token.");
          }
          break;
        case "SequenceExpression": {
          let R = A(L.expressions);
          L.range = [d(L), Math.min(f(R), f(L))];
          break;
        }
        case "TopicReference":
        ...
        case "ExportAllDeclaration": {
          let { exported: R } = L;
          if ($.parser === "meriyah" && R && R.type === "Identifier") {
            let h = $.originalText.slice(d(R), f(R));
            (h.startsWith('"') || h.startsWith("'")) && (L.exported = Object.assign(Object.assign({}, L.exported), {}, { type: "Literal", value: L.exported.name, raw: h }));
          }
          break;
        }
      }
    ...
    function X(L, R) {
      $.originalText[f(R)] !== ";" && (L.range = [d(L), f(R)]);
    }
  }
  function C(N) {
    switch (N.type) {
  ...
  function _(N) {
    return F(N) ? _({ type: "LogicalExpression", operator: N.operator, left: _({ type: "LogicalExpression", operator: N.operator, left: N.left, right: N.right.left, range: [d(N.left), f(N.right.left)] }), right: N.right.right, range: [d(N), f(N)] }) : N;
  }
  c.exports = I;
} });
...
- Did you mean \`import { "${r}" as foo }\`?`;
  ...
  }, YieldBindingIdentifier: "Can not use 'yield' as identifier inside a generator.", YieldInParameter: "Yield expression is not allowed in formal parameters.", ZeroDigitNumericSeparator: "Numeric separator can not be used after leading 0." }, F = { StrictDelete: "Deleting local variable in strict mode.", StrictEvalArguments: (t) => {
    let { referenceName: r } = t;
    return `Assigning to '${r}' in strict mode.`;
  }, StrictEvalArgumentsBinding: (t) => {
    let { bindingName: r } = t;
    return `Binding '${r}' in strict mode.`;
  }, StrictFunction: "In strict mode code, functions can only be declared at top level or inside a block.", StrictNumericEscape: "The only valid numeric escape in strict mode is '\\0'.", StrictOctalLiteral: "Legacy octal literals are not allowed in strict mode.", StrictWith: "'with' in strict mode." }, _ = /* @__PURE__ */ new Set(["ArrowFunctionExpression", "AssignmentExpression", "ConditionalExpression", "YieldExpression"]), N = { PipeBodyIsTighter: "Unexpected yield after pipeline body; any yield expression acting as Hack-style pipe body must be parenthesized due to its loose operator precedence.", PipeTopicRequiresHackPipes: 'Topic reference is used, but the pipelineOperator plugin was not passed a "proposal": "hack" or "smart" option.', PipeTopicUnbound: "Topic reference is unbound; it must be inside a pipe body.", PipeTopicUnconfiguredToken: (t) => {
    let { token: r } = t;
  ...
  function L(t) {
    ...
    return function s(i) {
      ...
      return T(SyntaxError, Object.assign({}, e, { loc: a }), { clone() {
        ...
        return s({ loc: new d("line" in u ? u.line : this.loc.line, "column" in u ? u.column : this.loc.column, "index" in u ? u.index : this.loc.index), details: Object.assign({}, this.details, o.details) });
  ...
  function R(t, r) {
    ...
    for (let s of Object.keys(t)) {
      ...
      e[s] = L(Object.assign({ code: g.SyntaxError, reasonCode: s, toMessage: u }, r ? { syntaxPlugin: r } : {}, o));
    }
    return e;
  }
  var h = Object.assign({}, R(S), R(C), R(F), R`pipelineOperator`(N)), { defineProperty: Y } = Object, oe = (t, r) => Y(t, r, { enumerable: false, value: t[r] });
  function Z(t) {
  ...
  var M = true, v = true, De = true, V = true, Q = true, me = true, de = class {
    constructor(t) {
  ...
  function k(t) {
    let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    var e, s, i, a;
    return ++ne, Ue.push(t), Ye.push((e = r.binop) != null ? e : -1), ue.push((s = r.beforeExpr) != null ? s : false), Qe.push((i = r.startsExpr) != null ? i : false), Ze.push((a = r.prefix) != null ? a : false), he.push(new de(t, r)), ne;
  }
  function H(t) {
    let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {};
    var e, s, i, a;
    return ++ne, le.set(t, ne), Ue.push(t), Ye.push((e = r.binop) != null ? e : -1), ue.push((s = r.beforeExpr) != null ? s : false), Qe.push((i = r.startsExpr) != null ? i : false), Ze.push((a = r.prefix) != null ? a : false), he.push(new de("name", r)), ne;
  }
  ...
  var $e = 0, ze = 1, Pe = 2, Xt = 4, xr = 8, dt = 16, gr = 32, Fe = 64, ft = 128, Ve = 256, mt = ze | Pe | ft | Ve, Ae = 1, Le = 2, Pr = 4, Ce = 8, yt = 16, Ar = 64, xt = 128, Yt = 256, Qt = 512, Zt = 1024, es = 2048, et = 4096, Tr = Ae | Le | Ce | xt, Oe = Ae | 0 | Ce | 0, gt = Ae | 0 | Pr | 0, vr = Ae | 0 | yt | 0, Oo = 0 | Le | 0 | xt, Mo = 0 | Le | 0 | 0, Er = Ae | Le | Ce | Yt, br = 0 | Zt, Se = 0 | Ar, Bo = Ae | 0 | 0 | Ar, _o = Er | Qt, Ro = 0 | Zt, Cr = 0 | Le | 0 | et, jo = es, Pt = 4, ts = 2, ss = 1, rs = ts | ss, qo = ts | Pt, Uo = ss | Pt, Ho = ts, $o = ss, is = 0, as = class {
    ...
    treatFunctionsAsVarInScope(t) {
      return !!(t.flags & (Pe | ft) || !this.parser.inModule && t.flags & ze);
    }
    declareName(t, r, e) {
...
`);
  ...
  var sl = /* @__PURE__ */ new Set([103, 109, 115, 105, 121, 117, 100, 118]), we = class {
    ...
    raise(t, r) {
      let { at: e } = r, s = c(r, el), i = e instanceof d ? e : e.loc.start, a = t({ loc: i, details: s });
      if (!this.options.errorRecovery)
        throw a;
      return this.isLookahead || this.state.errors.push(a), a;
    }
    raiseOverwrite(t, r) {
      let { at: e } = r, s = c(r, tl), i = e instanceof d ? e : e.loc.start, a = i.index, n = this.state.errors;
  ...
  var Al = /\*?\s*@((?:no)?flow)\b/, Tl = (t) => class extends t {
    ...
    flowParseDeclareModule(e) {
      ...
      let a = null, n = false;
      return i.forEach((o) => {
        xl(o) ? (a === "CommonJS" && this.raise(D.AmbiguousDeclareModuleKind, { at: o }), a = "ES") : o.type === "DeclareModuleExports" && (n && this.raise(D.DuplicateDeclareModuleExports, { at: o }), a === "ES" && this.raise(D.AmbiguousDeclareModuleKind, { at: o }), a = "CommonJS", n = true);
    ...
    flowParseDeclareExportDeclaration(e, s) {
      ...
      if (this.match(75) || this.isLet() || (this.isContextual(128) || this.isContextual(127)) && !s) {
        ...
        throw this.raise(D.UnsupportedDeclareExportKind, { at: this.state.startLoc, unsupportedExportKind: i, suggestion: gl[i] });
      }
    ...
    checkReservedType(e, s, i) {
      !yl.has(e) || this.raise(i ? D.AssignReservedType : D.UnexpectedReservedType, { at: s, reservedType: e });
    }
    ...
    flowParseObjectType(e) {
      ...
      for (i && this.match(6) ? (this.expect(6), m = 9, y = true) : (this.expect(5), m = 8, y = false), p.exact = y; !this.match(m); ) {
        ...
        this.flowObjectTypeSemicolon(), se && !this.match(8) && !this.match(9) && this.raise(D.UnexpectedExplicitInexactInObject, { at: se });
      }
    ...
    parseConditional(e, s, i) {
      ...
      if (p || y.length > 0) {
        ...
        p && m.length > 1 && this.raise(D.AmbiguousConditionalArrow, { at: a.startLoc }), p && m.length === 1 && (this.state = a, P.push(m[0].start), this.state.noArrowAt = P, { consequent: u, failed: p } = this.tryParseConditionalConsequent());
      }
    ...
    parseMaybeAssign(e, s) {
      ...
      if ((i = n) != null && i.error || this.match(47)) {
        ...
        throw (u = n) != null && u.thrown ? n.error : m.thrown ? m.error : this.raise(D.UnexpectedTokenAfterTypeParameter, { at: p });
      }
    ...
    flowEnumMembers(e) {
      ...
      for (; !this.match(8); ) {
        ...
        if (y === "")
          continue;
        /^[a-z]/.test(y) && this.raise(D.EnumInvalidMemberName, { at: p, memberName: y, suggestion: y[0].toUpperCase() + y.slice(1), enumName: s }), a.has(y) && this.raise(D.EnumDuplicateMemberName, { at: p, memberName: y, enumName: s }), a.add(y);
...
`) : i = String.fromCharCode(s), ++this.state.curLine, this.state.lineStart = this.state.pos, i;
  ...
  var w = R`typescript`({ AbstractMethodHasImplementation: (t) => {
    let { methodName: r } = t;
  ...
  var $r = R`placeholders`({ ClassNameIsRequired: "A class name is required.", UnexpectedSpace: "Unexpected space in placeholder." }), Fl = (t) => class extends t {
    parsePlaceholder(e) {
      if (this.match(142)) {
        let s = this.startNode();
  ...
  var _l = (t, r) => Object.hasOwnProperty.call(t, r) && t[r], Jr = (t) => t.type === "ParenthesizedExpression" ? Jr(t.expression) : t, Rl = class extends ml {
    ...
    parseHackPipeBody() {
      ...
      return _.has(e.type) && !((t = e.extra) != null && t.parenthesized) && this.raise(h.PipeUnparenthesizedBody, { at: r, type: e.type }), this.topicReferenceWasUsedInCurrentContext() || this.raise(h.PipeTopicUnused, { at: r }), e;
    }
...
`), cooked: i === null ? null : i.slice(1, u) }, n.tail = o, this.next();
    ...
    parseMethod(t, r, e, s, i, a) {
      ...
      let o = s;
      this.scope.enter(Pe | dt | (n ? Fe : 0) | (i ? gr : 0)), this.prodParam.enter(bt(e, t.generator)), this.parseFunctionParams(t, o);
    ...
    checkReservedWord(t, r, e, s) {
      ...
      (this.state.strict ? s ? yr : fr : dr)(t, this.inModule) && this.raise(h.UnexpectedReservedWord, { at: r, reservedWord: t });
    }
    isAwaitAllowed() {
  ...
  }, ds = { kind: "loop" }, ql = { kind: "switch" }, Ul = 0, fs = 1, Xr = 2, Yr = 4, Hl = /[\uD800-\uDFFF]/u, ms = /in(?:stanceof)?/y;
  function $l(t, r) {
  ...
  var zl = class extends jl {
    ...
    parseFunctionStatement(t, r, e) {
      return this.next(), this.parseFunction(t, fs | (e ? 0 : Xr), r);
    }
    parseIfStatement(t) {
    ...
    parseFunction(t) {
      let r = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : Ul, e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : false, s = r & fs, i = r & Xr, a = !!s && !(r & Yr);
    ...
    parseInitializer(t) {
      this.scope.enter(Fe | dt), this.expressionScope.enter(Br()), this.prodParam.enter(Ke), t.value = this.eat(29) ? this.parseMaybeAssignAllowIn() : null, this.expressionScope.exit(), this.prodParam.exit(), this.scope.exit();
    }
    parseClassId(t, r, e) {
    ...
    parseExportDefaultExpression() {
      ...
      if (this.match(68) || r)
        return this.next(), r && this.next(), this.parseFunction(t, fs | Yr, r);
      if (this.match(80))
    ...
    parseExportSpecifier(t, r, e, s) {
      return this.eatContextual(93) ? t.exported = this.parseModuleExportName() : r ? t.exported = fl(t.local) : t.exported || (t.exported = Te(t.local)), this.finishNode(t, "ExportSpecifier");
    }
...
var hd = W({ "src/language-js/parse/json.js"(l, c) {
  "use strict";
  K();
  var d = or(), f = lr(), x = oo(), g = lo();
  function A() {
    let C = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, { allowComments: F = true } = C;
    return function(N) {
  ...
  function T(C, F) {
    let [_, N] = [C.loc.start, C.loc.end].map(($) => {
      let { line: X, column: L } = $;
      return { line: X, column: L + 1 };
    });
    return f(`${F} is not allowed in JSON.`, { start: _, end: N });
  }
  function S(C) {
    switch (C.type) {
      case "ArrayExpression":
      ...
      case "UnaryExpression": {
        let { operator: F, argument: _ } = C;
        if (F !== "+" && F !== "-")
          throw T(C, `Operator '${C.operator}'`);
        if (_.type === "NumericLiteral" || _.type === "Identifier" && (_.name === "Infinity" || _.name === "NaN"))
          return;
        throw T(_, `Operator '${F}' before '${_.type}'`);
      }
      case "Identifier":
...
var ud = W({ "src/language-js/parse/babel.js"(l, c) {
  K();
  var d = zp(), f = Vn(), x = Gp(), g = oo(), A = lo(), T = ld(), S = hd(), O = { sourceType: "module", allowImportExportEverywhere: true, allowReturnOutsideFunction: true, allowSuperOutsideMethod: true, allowUndeclaredExports: true, errorRecovery: true, createParenthesizedExpressions: true, plugins: ["doExpressions", "exportDefaultFrom", "functionBind", "functionSent", "throwExpressions", "partialApplication", ["decorators", { decoratorsBeforeExport: false }], "importAssertions", "decimal", "moduleBlocks", "asyncDoExpressions", "regexpUnicodeSets", "destructuringPrivate", "decoratorAutoAccessors"], tokens: true, ranges: true }, I = ["recordAndTuple", { syntaxType: "hash" }], C = "v8intrinsic", F = [["pipelineOperator", { proposal: "hack", topicToken: "%" }], ["pipelineOperator", { proposal: "minimal" }], ["pipelineOperator", { proposal: "fsharp" }]], _ = function(V) {
  ...
  function $(V, Q) {
    ...
    let de = x(V, 0);
    return de !== false && (V = V.slice(0, de)), N.test(V);
  }
  function X(V, Q, me) {
  ...
  function L(V) {
    for (var Q = arguments.length, me = new Array(Q > 1 ? Q - 1 : 0), de = 1; de < Q; de++)
    ...
    return function(le, j) {
      ...
      let ne = me;
      G.__babelSourceType === "script" && (ne = ne.map((ue) => Object.assign(Object.assign({}, ue), {}, { sourceType: "script" }))), /#[[{]/.test(le) && (ne = ne.map((ue) => _([I], ue)));
      let he = /%[A-Z]/.test(le);
      le.includes("|>") ? ne = (he ? [...F, C] : F).flatMap((Qe) => ne.map((Ze) => _([Qe], Ze))) : he && (ne = ne.map((ue) => _([C], ue)));
      let { result: Ue, error: Ye } = d(...ne.map((ue) => () => X(V, le, ue)));
      if (!Ue)
        throw A(Ye);
      return G.originalText = le, T(Ue, G);
    };
  }
  var R = L("parse", _(["jsx", "flow"])), h = L("parse", _(["jsx", ["flow", { all: true, enums: true }]])), Y = L("parse", _(["jsx", "typescript"]), _(["typescript"])), oe = L("parse", _(["jsx", "flow", "estree"])), Z = L("parseExpression", _(["jsx"])), Ee = L("parseExpression", _(["typescript"])), te = /* @__PURE__ */ new Set(["StrictNumericEscape", "StrictWith", "StrictOctalLiteral", "StrictDelete", "StrictEvalArguments", "StrictEvalArgumentsBinding", "StrictFunction", "EmptyTypeArguments", "EmptyTypeParameters", "ConstructorHasTypeParameters", "UnsupportedParameterPropertyKind", "UnexpectedParameterModifier", "MixedLabeledAndUnlabeledElements", "InvalidTupleMemberLabel", "NonClassMethodPropertyHasAbstractModifer", "ReadonlyForMethodSignature", "ClassMethodHasDeclare", "ClassMethodHasReadonly", "InvalidModifierOnTypeMember", "DuplicateAccessibilityModifier", "IndexSignatureHasDeclare", "DecoratorExportClass", "ParamDupe", "InvalidDecimal", "RestTrailingComma", "UnsupportedParameterDecorator", "UnterminatedJsxContent", "UnexpectedReservedWord", "ModuleAttributesWithDuplicateKeys", "LineTerminatorBeforeArrow", "InvalidEscapeSequenceTemplate", "NonAbstractClassHasAbstractMethod", "UnsupportedPropertyDecorator", "OptionalTypeBeforeRequired", "PatternIsOptional", "OptionalBindingPattern", "DeclareClassFieldHasInitializer", "TypeImportCannotSpecifyDefaultAndNamed", "DeclareFunctionHasImplementation", "ConstructorClassField", "VarRedeclaration", "InvalidPrivateFieldResolution", "DuplicateExport"]), U = g(R), M = g(Y), v = g(Z), De = g(Ee);
