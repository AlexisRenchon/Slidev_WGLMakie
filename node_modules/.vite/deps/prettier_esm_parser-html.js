...
var X = T((Rl, Gr) => {
  ...
  Gr.exports = Ne(typeof globalThis == "object" && globalThis) || Ne(typeof window == "object" && window) || Ne(typeof self == "object" && self) || Ne(typeof global == "object" && global) || function() {
    return this;
...
var ce = T((Ll, zr) => {
  ...
  zr.exports = ps ? qe.bind(qe) : function() {
    return qe.apply(qe, arguments);
  };
});
var Kr = T((Qr) => {
  "use strict";
  var Wr = {}.propertyIsEnumerable, Yr = Object.getOwnPropertyDescriptor, fs = Yr && !Wr.call({ 1: 2 }, 1);
  Qr.f = fs ? function(r) {
    var u = Yr(this, r);
...
var ue = T((jl, ru) => {
  var Zr = Oe(), eu = Function.prototype, ds = eu.bind, er = eu.call, Es = Zr && ds.bind(er, er);
  ru.exports = Zr ? function(e) {
    return e && Es(e);
  } : function(e) {
    return e && function() {
...
var Re = T((Ul, tu) => {
  var uu = ue(), Cs = uu({}.toString), ms = uu("".slice);
  tu.exports = function(e) {
    return ms(Cs(e), 8, -1);
  };
});
var su = T((Gl, nu) => {
  var gs = X(), Fs = ue(), As = ie(), vs = Re(), rr = gs.Object, _s = Fs("".split);
  nu.exports = As(function() {
    return !rr("z").propertyIsEnumerable(0);
  }) ? function(e) {
    return vs(e) == "String" ? _s(e, "") : rr(e);
  } : rr;
});
var ur = T((Vl, iu) => {
...
var nr = T((Yl, cu) => {
  var Os = ue();
  cu.exports = Os({}.isPrototypeOf);
});
var pu = T((Ql, hu) => {
  var qs = Ae();
  hu.exports = qs("navigator", "userAgent") || "";
});
var Fu = T((Kl, gu) => {
  var mu = X(), sr = pu(), fu = mu.process, du = mu.Deno, Eu = fu && fu.versions || du && du.version, Cu = Eu && Eu.v8, ne, Pe;
  Cu && (ne = Cu.split("."), Pe = ne[0] > 0 && ne[0] < 4 ? 1 : +(ne[0] + ne[1]));
  !Pe && sr && (ne = sr.match(/Edge\/(\d+)/), (!ne || ne[1] >= 74) && (ne = sr.match(/Chrome\/(\d+)/), ne && (Pe = +ne[1])));
  gu.exports = Pe;
});
var ir = T((Jl, vu) => {
  var Au = Fu(), Is = ie();
  vu.exports = !!Object.getOwnPropertySymbols && !Is(function() {
    var e = Symbol();
...
var ar = T((Zl, _u) => {
  var Rs = ir();
  _u.exports = Rs && !Symbol.sham && typeof Symbol.iterator == "symbol";
});
var or = T((ec, Su) => {
  var xs = X(), Ps = Ae(), ks = te(), Ls = nr(), $s = ar(), Ms = xs.Object;
  Su.exports = $s ? function(e) {
    return typeof e == "symbol";
  } : function(e) {
    var r = Ps("Symbol");
    return ks(r) && Ls(r.prototype, Ms(e));
  };
});
var ke = T((rc, yu) => {
  var js = X(), Us = js.String;
...
var ve = T((uc, Tu) => {
  var Gs = X(), Vs = te(), Xs = ke(), Hs = Gs.TypeError;
  Tu.exports = function(e) {
    if (Vs(e))
      return e;
...
var Le = T((tc, Bu) => {
  ...
  Bu.exports = function(e, r) {
    var u = e[r];
    return u == null ? void 0 : zs(u);
  };
});
var wu = T((nc, bu) => {
  var Ws = X(), Dr = ce(), lr = te(), cr = he(), Ys = Ws.TypeError;
  bu.exports = function(e, r) {
    var u, s;
    if (r === "string" && lr(u = e.toString) && !cr(s = Dr(u, e)) || lr(u = e.valueOf) && !cr(s = Dr(u, e)) || r !== "string" && lr(u = e.toString) && !cr(s = Dr(u, e)))
      return s;
...
var $e = T((ic, Iu) => {
  var qu = X(), Qs = Object.defineProperty;
  Iu.exports = function(e, r) {
    try {
      Qs(qu, e, { value: r, configurable: true, writable: true });
    } catch {
      qu[e] = r;
    }
    return r;
...
var Me = T((ac, xu) => {
  var Ks = X(), Js = $e(), Ru = "__core-js_shared__", Zs = Ks[Ru] || Js(Ru, {});
  xu.exports = Zs;
});
var hr = T((oc, ku) => {
  var ei = Ou(), Pu = Me();
  (ku.exports = function(e, r) {
    return Pu[e] || (Pu[e] = r !== void 0 ? r : {});
  })("versions", []).push({ version: "3.22.2", mode: ei ? "pure" : "global", copyright: "\xA9 2014-2022 Denis Pushkarev (zloirock.ru)", license: "https://github.com/zloirock/core-js/blob/v3.22.2/LICENSE", source: "https://github.com/zloirock/core-js" });
});
var pr = T((Dc, Lu) => {
  var ri = X(), ui = ur(), ti = ri.Object;
  Lu.exports = function(e) {
    return ti(ui(e));
  };
});
var oe = T((lc, $u) => {
  var ni = ue(), si = pr(), ii = ni({}.hasOwnProperty);
  $u.exports = Object.hasOwn || function(r, u) {
    return ii(si(r), u);
  };
});
var fr = T((cc, Mu) => {
  var ai = ue(), oi = 0, Di = Math.random(), li = ai(1 .toString);
  Mu.exports = function(e) {
    return "Symbol(" + (e === void 0 ? "" : e) + ")_" + li(++oi + Di, 36);
  };
});
var fe = T((hc, Xu) => {
  var ci = X(), hi = hr(), ju = oe(), pi = fr(), Uu = ir(), Vu = ar(), Ce = hi("wks"), pe = ci.Symbol, Gu = pe && pe.for, fi = Vu ? pe : pe && pe.withoutSetter || pi;
  Xu.exports = function(e) {
    if (!ju(Ce, e) || !(Uu || typeof Ce[e] == "string")) {
      var r = "Symbol." + e;
      Uu && ju(pe, e) ? Ce[e] = pe[e] : Vu && Gu ? Ce[e] = Gu(r) : Ce[e] = fi(r);
    }
    return Ce[e];
  };
});
var Yu = T((pc, Wu) => {
  var di = X(), Ei = ce(), Hu = he(), zu = or(), Ci = Le(), mi = wu(), gi = fe(), Fi = di.TypeError, Ai = gi("toPrimitive");
  Wu.exports = function(e, r) {
    if (!Hu(e) || zu(e))
      return e;
    var u = Ci(e, Ai), s;
    if (u) {
      if (r === void 0 && (r = "default"), s = Ei(u, e, r), !Hu(s) || zu(s))
        return s;
      throw Fi("Can't convert object to primitive value");
    }
    return r === void 0 && (r = "number"), mi(e, r);
  };
});
var je = T((fc, Qu) => {
  var vi = Yu(), _i = or();
...
var Zu = T((dc, Ju) => {
  var Si = X(), Ku = he(), dr = Si.document, yi = Ku(dr) && Ku(dr.createElement);
  Ju.exports = function(e) {
    return yi ? dr.createElement(e) : {};
  };
});
var Er = T((Ec, et) => {
  var Ti = le(), Bi = ie(), bi = Zu();
  et.exports = !Ti && !Bi(function() {
    return Object.defineProperty(bi("div"), "a", { get: function() {
      return 7;
    } }).a != 7;
  });
});
var Cr = T((ut) => {
  var wi = le(), Ni = ce(), Oi = Kr(), qi = Ie(), Ii = xe(), Ri = je(), xi = oe(), Pi = Er(), rt = Object.getOwnPropertyDescriptor;
  ut.f = wi ? rt : function(r, u) {
    if (r = Ii(r), u = Ri(u), Pi)
      try {
        return rt(r, u);
      } catch {
    ...
    if (xi(r, u))
      return qi(!Ni(Oi.f, r, u), r[u]);
  };
});
var nt = T((mc, tt) => {
  var ki = le(), Li = ie();
  tt.exports = ki && Li(function() {
    return Object.defineProperty(function() {
    }, "prototype", { value: 42, writable: false }).prototype != 42;
  });
});
var me = T((gc, it) => {
  var st = X(), $i = he(), Mi = st.String, ji = st.TypeError;
  it.exports = function(e) {
    if ($i(e))
      return e;
    throw ji(Mi(e) + " is not an object");
  };
});
var Ge = T((ot) => {
  var Ui = X(), Gi = le(), Vi = Er(), Xi = nt(), Ue = me(), at = je(), Hi = Ui.TypeError, mr = Object.defineProperty, zi = Object.getOwnPropertyDescriptor, gr = "enumerable", Fr = "configurable", Ar = "writable";
  ot.f = Gi ? Xi ? function(r, u, s) {
    if (Ue(r), u = at(u), Ue(s), typeof r == "function" && u === "prototype" && "value" in s && Ar in s && !s[Ar]) {
      var D = zi(r, u);
      D && D[Ar] && (r[u] = s.value, s = { configurable: Fr in s ? s[Fr] : D[Fr], enumerable: gr in s ? s[gr] : D[gr], writable: false });
    }
    return mr(r, u, s);
  } : mr : function(r, u, s) {
    if (Ue(r), u = at(u), Ue(s), Vi)
      try {
        return mr(r, u, s);
      } catch {
      }
    if ("get" in s || "set" in s)
      throw Hi("Accessors not supported");
    return "value" in s && (r[u] = s.value), r;
  };
});
var Ve = T((Ac, Dt) => {
  var Wi = le(), Yi = Ge(), Qi = Ie();
  Dt.exports = Wi ? function(e, r, u) {
    return Yi.f(e, r, Qi(1, u));
  } : function(e, r, u) {
    return e[r] = u, e;
  };
});
var Xe = T((vc, lt) => {
  var Ki = ue(), Ji = te(), vr = Me(), Zi = Ki(Function.toString);
  Ji(vr.inspectSource) || (vr.inspectSource = function(e) {
    return Zi(e);
  });
  lt.exports = vr.inspectSource;
});
var pt = T((_c, ht) => {
  var ea = X(), ra = te(), ua = Xe(), ct = ea.WeakMap;
  ht.exports = ra(ct) && /native code/.test(ua(ct));
});
var Et = T((Sc, dt) => {
  var ta = hr(), na = fr(), ft = ta("keys");
  dt.exports = function(e) {
    return ft[e] || (ft[e] = na(e));
  };
});
var _r = T((yc, Ct) => {
  Ct.exports = {};
...
var _t = T((Tc, vt) => {
  var sa = pt(), At = X(), Sr = ue(), ia = he(), aa = Ve(), yr = oe(), Tr = Me(), oa = Et(), Da = _r(), mt = "Object already initialized", br = At.TypeError, la = At.WeakMap, He, _e, ze, ca = function(e) {
    return ze(e) ? _e(e) : He(e, {});
  }, ha = function(e) {
    return function(r) {
      var u;
      if (!ia(r) || (u = _e(r)).type !== e)
        throw br("Incompatible receiver, " + e + " required");
      return u;
    };
  };
  sa || Tr.state ? (De = Tr.state || (Tr.state = new la()), gt = Sr(De.get), Br = Sr(De.has), Ft = Sr(De.set), He = function(e, r) {
    if (Br(De, e))
      throw new br(mt);
    return r.facade = e, Ft(De, e, r), r;
  }, _e = function(e) {
    return gt(De, e) || {};
  }, ze = function(e) {
    return Br(De, e);
  }) : (de = oa("state"), Da[de] = true, He = function(e, r) {
    if (yr(e, de))
      throw new br(mt);
    return r.facade = e, aa(e, de, r), r;
  }, _e = function(e) {
    return yr(e, de) ? e[de] : {};
  }, ze = function(e) {
    return yr(e, de);
  ...
  var De, gt, Br, Ft, de;
  vt.exports = { set: He, get: _e, has: ze, enforce: ca, getterFor: ha };
});
var Tt = T((Bc, yt) => {
  var wr = le(), pa = oe(), St = Function.prototype, fa = wr && Object.getOwnPropertyDescriptor, Nr = pa(St, "name"), da = Nr && function() {
  }.name === "something", Ea = Nr && (!wr || wr && fa(St, "name").configurable);
  yt.exports = { EXISTS: Nr, PROPER: da, CONFIGURABLE: Ea };
});
var Ot = T((bc, Nt) => {
  var Ca = X(), Bt = te(), ma = oe(), bt = Ve(), ga = $e(), Fa = Xe(), wt = _t(), Aa = Tt().CONFIGURABLE, va = wt.get, _a = wt.enforce, Sa = String(String).split("String");
  (Nt.exports = function(e, r, u, s) {
    var D = s ? !!s.unsafe : false, n = s ? !!s.enumerable : false, i = s ? !!s.noTargetGet : false, f = s && s.name !== void 0 ? s.name : r, l;
    if (Bt(u) && (String(f).slice(0, 7) === "Symbol(" && (f = "[" + String(f).replace(/^Symbol\(([^)]*)\)/, "$1") + "]"), (!ma(u, "name") || Aa && u.name !== f) && bt(u, "name", f), l = _a(u), l.source || (l.source = Sa.join(typeof f == "string" ? f : ""))), e === Ca) {
      n ? e[r] = u : ga(r, u);
      return;
    } else
    ...
    return Bt(this) && va(this).source || Fa(this);
  });
});
var Or = T((wc, qt) => {
  var ya = Math.ceil, Ta = Math.floor;
  qt.exports = function(e) {
    var r = +e;
    return r !== r || r === 0 ? 0 : (r > 0 ? Ta : ya)(r);
  };
});
var Rt = T((Nc, It) => {
  var Ba = Or(), ba = Math.max, wa = Math.min;
  It.exports = function(e, r) {
    var u = Ba(e);
    return u < 0 ? ba(u + r, 0) : wa(u, r);
  };
});
var Pt = T((Oc, xt) => {
  var Na = Or(), Oa = Math.min;
  xt.exports = function(e) {
    return e > 0 ? Oa(Na(e), 9007199254740991) : 0;
  };
});
var Se = T((qc, kt) => {
  var qa = Pt();
...
var Mt = T((Ic, $t) => {
  var Ia = xe(), Ra = Rt(), xa = Se(), Lt = function(e) {
    return function(r, u, s) {
      var D = Ia(r), n = xa(D), i = Ra(s, n), f;
      if (e && u != u) {
        for (; n > i; )
          if (f = D[i++], f != f)
            return true;
  ...
  $t.exports = { includes: Lt(true), indexOf: Lt(false) };
});
var Gt = T((Rc, Ut) => {
  var Pa = ue(), qr = oe(), ka = xe(), La = Mt().indexOf, $a = _r(), jt = Pa([].push);
  Ut.exports = function(e, r) {
    var u = ka(e), s = 0, D = [], n;
    for (n in u)
      !qr($a, n) && qr(u, n) && jt(D, n);
    for (; r.length > s; )
      qr(u, n = r[s++]) && (~La(D, n) || jt(D, n));
    return D;
  };
});
var Xt = T((xc, Vt) => {
  Vt.exports = ["constructor", "hasOwnProperty", "isPrototypeOf", "propertyIsEnumerable", "toLocaleString", "toString", "valueOf"];
});
var zt = T((Ht) => {
  var Ma = Gt(), ja = Xt(), Ua = ja.concat("length", "prototype");
  Ht.f = Object.getOwnPropertyNames || function(r) {
    return Ma(r, Ua);
  };
});
var Yt = T((Wt) => {
...
var Kt = T((Lc, Qt) => {
  var Ga = Ae(), Va = ue(), Xa = zt(), Ha = Yt(), za = me(), Wa = Va([].concat);
  Qt.exports = Ga("Reflect", "ownKeys") || function(r) {
    var u = Xa.f(za(r)), s = Ha.f;
    return s ? Wa(u, s(r)) : u;
  };
});
var en = T(($c, Zt) => {
  var Jt = oe(), Ya = Kt(), Qa = Cr(), Ka = Ge();
  Zt.exports = function(e, r, u) {
    for (var s = Ya(r), D = Ka.f, n = Qa.f, i = 0; i < s.length; i++) {
      var f = s[i];
      !Jt(e, f) && !(u && Jt(u, f)) && D(e, f, n(r, f));
    }
  };
});
var un = T((Mc, rn) => {
  var Ja = ie(), Za = te(), eo = /#|\.prototype\./, ye = function(e, r) {
    var u = uo[ro(e)];
    return u == no ? true : u == to ? false : Za(r) ? Ja(r) : !!r;
  }, ro = ye.normalize = function(e) {
    return String(e).replace(eo, ".").toLowerCase();
  }, uo = ye.data = {}, to = ye.NATIVE = "N", no = ye.POLYFILL = "P";
  rn.exports = ye;
});
var We = T((jc, tn) => {
  var Ir = X(), so = Cr().f, io = Ve(), ao = Ot(), oo = $e(), Do = en(), lo = un();
  tn.exports = function(e, r) {
    var u = e.target, s = e.global, D = e.stat, n, i, f, l, v, a;
    if (s ? i = Ir : D ? i = Ir[u] || oo(u, {}) : i = (Ir[u] || {}).prototype, i)
      for (f in r) {
        if (v = r[f], e.noTargetGet ? (a = so(i, f), l = a && a.value) : l = i[f], n = lo(s ? f : u + (D ? "." : "#") + f, e.forced), !n && l !== void 0) {
          if (typeof v == typeof l)
            continue;
          Do(v, l);
        }
        (e.sham || l && l.sham) && io(v, "sham", true), ao(i, f, v, e);
      }
  };
});
var nn = T(() => {
  var co = We(), ho = X();
  co({ global: true }, { globalThis: ho });
});
var Rr = T((Vc, sn) => {
  var po = Re();
  sn.exports = Array.isArray || function(r) {
    return po(r) == "Array";
  };
});
var xr = T((Xc, on) => {
  var an = ue(), fo = ve(), Eo = Oe(), Co = an(an.bind);
...
var cn = T((Hc, ln) => {
  "use strict";
  var mo = X(), go = Rr(), Fo = Se(), Ao = xr(), vo = mo.TypeError, Dn = function(e, r, u, s, D, n, i, f) {
    for (var l = D, v = 0, a = i ? Ao(i, f) : false, c, p; v < s; ) {
      if (v in u) {
        if (c = a ? a(u[v], v, r) : u[v], n > 0 && go(c))
          p = Fo(c), l = Dn(e, r, c, p, l, n - 1) - 1;
        else {
...
var fn = T((zc, pn) => {
  var _o = fe(), So = _o("toStringTag"), hn = {};
  hn[So] = "z";
  pn.exports = String(hn) === "[object z]";
});
var Pr = T((Wc, dn) => {
  var yo = X(), To = fn(), Bo = te(), Ye = Re(), bo = fe(), wo = bo("toStringTag"), No = yo.Object, Oo = Ye(function() {
    return arguments;
  ...
  dn.exports = To ? Ye : function(e) {
    var r, u, s;
    return e === void 0 ? "Undefined" : e === null ? "Null" : typeof (u = qo(r = No(e), wo)) == "string" ? u : Oo ? Ye(r) : (s = Ye(r)) == "Object" && Bo(r.callee) ? "Arguments" : s;
  };
});
var An = T((Yc, Fn) => {
  var Io = ue(), Ro = ie(), En = te(), xo = Pr(), Po = Ae(), ko = Xe(), Cn = function() {
  }, Lo = [], mn = Po("Reflect", "construct"), kr = /^\s*(?:class|function)\b/, $o = Io(kr.exec), Mo = !kr.exec(Cn), Te = function(r) {
    if (!En(r))
      return false;
    try {
      return mn(Cn, Lo, r), true;
    } catch {
      return false;
    }
  }, gn = function(r) {
...
var yn = T((Qc, Sn) => {
  var jo = X(), vn = Rr(), Uo = An(), Go = he(), Vo = fe(), Xo = Vo("species"), _n = jo.Array;
  Sn.exports = function(e) {
    var r;
    return vn(e) && (r = e.constructor, Uo(r) && (r === _n || vn(r.prototype)) ? r = void 0 : Go(r) && (r = r[Xo], r === null && (r = void 0))), r === void 0 ? _n : r;
  };
});
var Bn = T((Kc, Tn) => {
  var Ho = yn();
...
var Nn = T((Zc, wn) => {
  var Zo = fe(), eD = Lr(), rD = Zo("iterator"), uD = Array.prototype;
  wn.exports = function(e) {
    return e !== void 0 && (eD.Array === e || uD[rD] === e);
  };
});
var $r = T((e2, qn) => {
  var tD = Pr(), On = Le(), nD = Lr(), sD = fe(), iD = sD("iterator");
  qn.exports = function(e) {
    if (e != null)
      return On(e, iD) || On(e, "@@iterator") || nD[tD(e)];
  };
});
var Rn = T((r2, In) => {
  var aD = X(), oD = ce(), DD = ve(), lD = me(), cD = ke(), hD = $r(), pD = aD.TypeError;
  In.exports = function(e, r) {
    var u = arguments.length < 2 ? hD(e) : r;
    if (DD(u))
      return lD(oD(u, e));
    throw pD(cD(e) + " is not iterable");
  };
});
var kn = T((u2, Pn) => {
  var fD = ce(), xn = me(), dD = Le();
  Pn.exports = function(e, r, u) {
    var s, D;
    xn(e);
    try {
      if (s = dD(e, "return"), !s) {
...
var Un = T((t2, jn) => {
  var ED = X(), CD = xr(), mD = ce(), gD = me(), FD = ke(), AD = Nn(), vD = Se(), Ln = nr(), _D = Rn(), SD = $r(), $n = kn(), yD = ED.TypeError, Qe = function(e, r) {
    this.stopped = e, this.result = r;
  }, Mn = Qe.prototype;
  jn.exports = function(e, r, u) {
    var s = u && u.that, D = !!(u && u.AS_ENTRIES), n = !!(u && u.IS_ITERATOR), i = !!(u && u.INTERRUPTED), f = CD(r, s), l, v, a, c, p, g, C, m = function(w) {
      return l && $n(l, "normal", w), new Qe(true, w);
    }, B = function(w) {
      return D ? (gD(w), i ? f(w[0], w[1], m) : f(w[0], w[1])) : i ? f(w, m) : f(w);
    };
    if (n)
      l = e;
    else {
      if (v = SD(e), !v)
        throw yD(FD(e) + " is not iterable");
      if (AD(v)) {
        for (a = 0, c = vD(e); c > a; a++)
          if (p = B(e[a]), p && Ln(Mn, p))
            return p;
        return new Qe(false);
      }
      l = _D(e, v);
    }
    for (g = l.next; !(C = mD(g, l)).done; ) {
      try {
        p = B(C.value);
      } catch (w) {
        $n(l, "throw", w);
      }
      if (typeof p == "object" && p && Ln(Mn, p))
        return p;
    }
    return new Qe(false);
  };
...
var Vn = T((n2, Gn) => {
  "use strict";
  var TD = je(), BD = Ge(), bD = Ie();
  Gn.exports = function(e, r, u) {
    var s = TD(r);
    s in e ? BD.f(e, s, bD(0, u)) : e[s] = u;
  };
});
nn();
var zo = We();
...
zo({ target: "Array", proto: true }, { flatMap: function(r) {
  var u = Qo(this), s = Ko(u), D;
  return Yo(r), D = Jo(u, 0), D.length = Wo(D, u, u, s, 0, 1, r, arguments.length > 1 ? arguments[1] : void 0), D;
} });
var wD = We();
var ND = Un();
var OD = Vn();
wD({ target: "Object", stat: true }, { fromEntries: function(r) {
  var u = {};
  return ND(r, function(s, D) {
    OD(u, s, D);
  }, { AS_ENTRIES: true }), u;
} });
var qD = ["cliName", "cliCategory", "cliDescription"];
function ID(e, r) {
  if (e == null)
    return {};
  var u = RD(e, r), s, D;
...
var Qn = (e, r, u, s) => {
  if (r && typeof r == "object" || typeof r == "function")
    for (let D of Mr(r))
      !LD.call(e, D) && D !== u && Ke(e, D, { get: () => r[D], enumerable: !(s = PD(r, D)) || s.enumerable });
  return e;
};
var $D = (e, r, u) => (u = e != null ? xD(kD(e)) : {}, Qn(r || !e || !e.__esModule ? Ke(u, "default", { value: e, enumerable: true }) : u, e));
var Kn = (e) => Qn(Ke({}, "__esModule", { value: true }), e);
var Xn;
var Hn;
var Be;
var O = ge({ "<define:process>"() {
  Xn = {}, Hn = [], Be = { env: Xn, argv: Hn };
} });
var Jn = I({ "node_modules/angular-html-parser/lib/compiler/src/chars.js"(e) {
  "use strict";
...
var MD = I({ "node_modules/angular-html-parser/lib/compiler/src/aot/static_symbol.js"(e) {
  "use strict";
  ...
  var u = class {
    ...
    get(s, D, n) {
      n = n || [];
      let i = n.length ? `.${n.join(".")}` : "", f = `"${s}".${D}${i}`, l = this.cache.get(f);
      return l || (l = new r(s, D, n), this.cache.set(f, l)), l;
    }
  };
  e.StaticSymbolCache = u;
} });
var jD = I({ "node_modules/angular-html-parser/lib/compiler/src/util.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = /-+([a-z0-9])/g;
  function u(o) {
...
var UD = I({ "node_modules/angular-html-parser/lib/compiler/src/compile_metadata.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = MD(), u = jD(), s = /^(?:(?:\[([^\]]+)\])|(?:\(([^\)]+)\)))|(\@[-\w]+)$/;
  function D(h) {
  ...
  function i(h) {
    ...
    let q = u.stringify(F);
    return q.indexOf("(") >= 0 ? (q = `anonymous_${n++}`, F.__anonymousType = q) : q = D(q), q;
  }
  e.identifierName = i;
  function f(h) {
    let F = h.reference;
  ...
  function l(h, F) {
    return `View_${i({ reference: h })}_${F}`;
  }
  e.viewClassName = l;
  function v(h) {
  ...
  function g(h) {
    return h.value != null ? D(h.value) : i(h.identifier);
  }
  e.tokenName = g;
  function C(h) {
  ...
  var w = class {
    static create(h) {
      let { isHost: F, type: q, isComponent: P, selector: G, exportAs: H, changeDetection: K, inputs: z, outputs: Y, host: J, providers: Z, viewProviders: _, queries: E, guards: A, viewQueries: y, entryComponents: x, template: $, componentViewType: V, rendererType: W, componentFactory: Q } = h, se = {}, Ee = {}, Ze = {};
      J != null && Object.keys(J).forEach((ee) => {
        let re = J[ee], ae = ee.match(s);
        ae === null ? Ze[ee] = re : ae[1] != null ? Ee[ae[1]] = re : ae[2] != null && (se[ae[2]] = re);
      });
      let Fe = {};
      z != null && z.forEach((ee) => {
        let re = u.splitAtColon(ee, [ee, ee]);
        Fe[re[0]] = re[1];
      });
      let we = {};
      return Y != null && Y.forEach((ee) => {
        let re = u.splitAtColon(ee, [ee, ee]);
        we[re[0]] = re[1];
      }), new w({ isHost: F, type: q, isComponent: !!P, selector: G, exportAs: H, changeDetection: K, inputs: Fe, outputs: we, hostListeners: se, hostProperties: Ee, hostAttributes: Ze, providers: Z, viewProviders: _, queries: E, guards: A, viewQueries: y, entryComponents: x, template: $, componentViewType: V, rendererType: W, componentFactory: Q });
    }
    constructor(h) {
      let { isHost: F, type: q, isComponent: P, selector: G, exportAs: H, changeDetection: K, inputs: z, outputs: Y, hostListeners: J, hostProperties: Z, hostAttributes: _, providers: E, viewProviders: A, queries: y, guards: x, viewQueries: $, entryComponents: V, template: W, componentViewType: Q, rendererType: se, componentFactory: Ee } = h;
  ...
  function L(h, F, q) {
    let P;
    return q.isInline ? F.type.reference instanceof r.StaticSymbol ? P = `${F.type.reference.filePath}.${F.type.reference.name}.html` : P = `${i(h)}/${i(F.type)}.html` : P = q.templateUrl, F.type.reference instanceof r.StaticSymbol ? P : j(P);
  }
  e.templateSourceUrl = L;
  function t(h, F) {
    let q = h.moduleUrl.split(/\/\\/g), P = q[q.length - 1];
    return j(`css/${F}${P}.ngstyle.js`);
  }
  e.sharedStylesheetJitUrl = t;
  function o(h) {
    return j(`${i(h.type)}/module.ngfactory.js`);
  }
  e.ngModuleJitUrl = o;
  function d(h, F) {
    return j(`${i(h)}/${i(F.type)}.ngfactory.js`);
  }
  e.templateJitUrl = d;
} });
var be = I({ "node_modules/angular-html-parser/lib/compiler/src/parse_util.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = Jn(), u = UD(), s = class {
    constructor(a, c, p, g) {
      this.file = a, this.offset = c, this.line = p, this.col = g;
    }
    toString() {
      return this.offset != null ? `${this.file.url}@${this.line}:${this.col}` : this.file.url;
    }
    moveBy(a) {
      let c = this.file.content, p = c.length, g = this.offset, C = this.line, m = this.col;
      for (; g > 0 && a < 0; )
        if (g--, a++, c.charCodeAt(g) == r.$LF) {
          C--;
          let w = c.substr(0, g - 1).lastIndexOf(String.fromCharCode(r.$LF));
          m = w > 0 ? g - w : g;
        } else
          m--;
      for (; g < p && a > 0; ) {
        let B = c.charCodeAt(g);
        g++, a--, B == r.$LF ? (C++, m = 0) : m++;
      }
...
` && ++B == c)); )
          ;
        for (m = 0, B = 0; m < a && C < p.length - 1 && (C++, m++, !(p[C] == `
` && ++B == c)); )
          ;
  ...
  var n = class {
    constructor(a, c) {
      ...
      this.start = a, this.end = c, this.details = p;
    }
    toString() {
  ...
  var f = class {
    constructor(a, c) {
      let p = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : i.ERROR;
      this.span = a, this.msg = c, this.level = p;
    }
    contextualMessage() {
  ...
  e.ParseError = f;
  function l(a, c) {
    let p = u.identifierModuleUrl(c), g = p != null ? `in ${a} ${u.identifierName(c)} in ${p}` : `in ${a} ${u.identifierName(c)}`, C = new D("", g);
    return new n(new s(C, -1, -1, -1), new s(C, -1, -1, -1));
  }
  e.typeSourceSpan = l;
  function v(a, c, p) {
    let g = `in ${a} ${c} in ${p}`, C = new D("", g);
    return new n(new s(C, -1, -1, -1), new s(C, -1, -1, -1));
  }
  e.r3JitTypeSourceSpan = v;
} });
var GD = I({ "src/utils/front-matter/parse.js"(e, r) {
  "use strict";
  O();
  ...
  function s(D) {
    ...
    if (!n)
      return { content: D };
    let { startDelimiter: i, language: f, value: l = "", endDelimiter: v } = n.groups, a = f.trim() || "yaml";
    if (i === "+++" && (a = "toml"), a !== "yaml" && i !== v)
      return { content: D };
    let [c] = n;
    return { frontMatter: { type: "front-matter", lang: a, value: l, startDelimiter: i, endDelimiter: v, raw: c.replace(/\n$/, "") }, content: c.replace(/[^\n]/g, " ") + D.slice(c.length) };
  }
  r.exports = s;
} });
var Zn = I({ "src/utils/get-last.js"(e, r) {
  "use strict";
  O();
  var u = (s) => s[s.length - 1];
  r.exports = u;
} });
var VD = I({ "src/common/parser-create-error.js"(e, r) {
  "use strict";
  O();
  function u(s, D) {
...
var HD = ge({ "node_modules/escape-string-regexp/index.js"() {
  O();
} });
var rs = I({ "node_modules/semver/internal/debug.js"(e, r) {
  O();
  var u = typeof Be == "object" && Be.env && Be.env.NODE_DEBUG && /\bsemver\b/i.test(Be.env.NODE_DEBUG) ? function() {
...
var zD = I({ "node_modules/semver/internal/re.js"(e, r) {
  O();
  var { MAX_SAFE_COMPONENT_LENGTH: u } = us(), s = rs();
  e = r.exports = {};
  var D = e.re = [], n = e.src = [], i = e.t = {}, f = 0, l = (v, a, c) => {
    let p = f++;
    s(v, p, a), i[v] = p, n[p] = a, D[p] = new RegExp(a, c ? "g" : void 0);
  };
...
var WD = I({ "node_modules/semver/internal/parse-options.js"(e, r) {
  O();
  var u = ["includePrerelease", "loose", "rtl"], s = (D) => D ? typeof D != "object" ? { loose: true } : u.filter((n) => D[n]).reduce((n, i) => (n[i] = true, n), {}) : {};
  r.exports = s;
} });
var YD = I({ "node_modules/semver/internal/identifiers.js"(e, r) {
  O();
  var u = /^[0-9]+$/, s = (n, i) => {
    let f = u.test(n), l = u.test(i);
    return f && l && (n = +n, i = +i), n === i ? 0 : f && !l ? -1 : l && !f ? 1 : n < i ? -1 : 1;
  }, D = (n, i) => s(i, n);
  r.exports = { compareIdentifiers: s, rcompareIdentifiers: D };
} });
var QD = I({ "node_modules/semver/classes/semver.js"(e, r) {
  O();
  var u = rs(), { MAX_LENGTH: s, MAX_SAFE_INTEGER: D } = us(), { re: n, t: i } = zD(), f = WD(), { compareIdentifiers: l } = YD(), v = class {
    constructor(a, c) {
      if (c = f(c), a instanceof v) {
      ...
      let p = a.trim().match(c.loose ? n[i.LOOSE] : n[i.FULL]);
      if (!p)
        throw new TypeError(`Invalid Version: ${a}`);
      if (this.raw = a, this.major = +p[1], this.minor = +p[2], this.patch = +p[3], this.major > D || this.major < 0)
    ...
    compare(a) {
      if (u("SemVer.compare", this.version, this.options, a), !(a instanceof v)) {
        if (typeof a == "string" && a === this.version)
          return 0;
        a = new v(a, this.options);
      }
      return a.version === this.version ? 0 : this.compareMain(a) || this.comparePre(a);
    }
    compareMain(a) {
      return a instanceof v || (a = new v(a, this.options)), l(this.major, a.major) || l(this.minor, a.minor) || l(this.patch, a.patch);
    }
    comparePre(a) {
      if (a instanceof v || (a = new v(a, this.options)), this.prerelease.length && !a.prerelease.length)
        return -1;
      ...
      let c = 0;
      do {
        let p = this.prerelease[c], g = a.prerelease[c];
        if (u("prerelease compare", c, p, g), p === void 0 && g === void 0)
          return 0;
        if (g === void 0)
          return 1;
        if (p === void 0)
    ...
    compareBuild(a) {
      a instanceof v || (a = new v(a, this.options));
      let c = 0;
      do {
        let p = this.build[c], g = a.build[c];
        if (u("prerelease compare", c, p, g), p === void 0 && g === void 0)
          return 0;
        if (g === void 0)
          return 1;
...
var jr = I({ "node_modules/semver/functions/compare.js"(e, r) {
  O();
  var u = QD(), s = (D, n, i) => new u(D, i).compare(new u(n, i));
  r.exports = s;
} });
var KD = I({ "node_modules/semver/functions/lt.js"(e, r) {
  O();
  var u = jr(), s = (D, n, i) => u(D, n, i) < 0;
  r.exports = s;
} });
var JD = I({ "node_modules/semver/functions/gte.js"(e, r) {
  O();
  var u = jr(), s = (D, n, i) => u(D, n, i) >= 0;
  r.exports = s;
} });
var ZD = I({ "src/utils/arrayify.js"(e, r) {
  "use strict";
  O(), r.exports = (u, s) => Object.entries(u).map((D) => {
    let [n, i] = D;
    return Object.assign({ [s]: n }, i);
  });
} });
var el = I({ "package.json"(e, r) {
  r.exports = { version: "2.8.0" };
} });
var rl = I({ "node_modules/outdent/lib/index.js"(e, r) {
  "use strict";
  ...
  function D() {
    return { add: u, delete: u, get: u, set: u, has: function(S) {
      return false;
    } };
  }
  var n = Object.prototype.hasOwnProperty, i = function(S, N) {
    return n.call(S, N);
  };
  function f(S, N) {
    for (var b in N)
  ...
  var l = /^[ \t]*(?:\r\n|\r|\n)/, v = /(?:\r\n|\r|\n)[ \t]*$/, a = /^(?:[\r\n]|$)/, c = /(?:\r\n|\r|\n)([ \t]*)(?:[^ \t\r\n]|$)/, p = /^[ \t]*[\r\n][ \t\r\n]*$/;
  function g(S, N, b) {
    var M = 0, R = S[0].match(c);
    R && (M = R[1].length);
    var U = "(\\r\\n|\\r|\\n).{0," + M + "}", k = new RegExp(U, "g");
    N && (S = S.slice(1));
    var j = b.newline, L = b.trimLeadingNewline, t = b.trimTrailingNewline, o = typeof j == "string", d = S.length, h = S.map(function(F, q) {
      return F = F.replace(k, "$1"), q === 0 && L && (F = F.replace(l, "")), q === d - 1 && t && (F = F.replace(v, "")), o && (F = F.replace(/\r\n|\n|\r/g, function(P) {
        return j;
      })), F;
    });
    return h;
  ...
  function C(S, N) {
    for (var b = "", M = 0, R = S.length; M < R; M++)
      b += S[M], M < R - 1 && (b += N[M]);
    return b;
  }
  function m(S) {
    return i(S, "raw") && i(S, "length");
  }
  function B(S) {
    var N = s(), b = s();
    function M(U) {
      for (var k = [], j = 1; j < arguments.length; j++)
        k[j - 1] = arguments[j];
      if (m(U)) {
        var L = U, t = (k[0] === M || k[0] === w) && p.test(L[0]) && a.test(L[1]), o = t ? b : N, d = o.get(L);
        if (d || (d = g(L, t, S), o.set(L, d)), k.length === 0)
          return d[0];
...
var ul = I({ "src/main/core-options.js"(e, r) {
  "use strict";
  O();
  var { outdent: u } = rl(), s = "Config", D = "Editor", n = "Format", i = "Other", f = "Output", l = "Global", v = "Special", a = { cursorOffset: { since: "1.4.0", category: v, type: "int", default: -1, range: { start: -1, end: Number.POSITIVE_INFINITY, step: 1 }, description: u`
  ...
  r.exports = { CATEGORY_CONFIG: s, CATEGORY_EDITOR: D, CATEGORY_FORMAT: n, CATEGORY_OTHER: i, CATEGORY_OUTPUT: f, CATEGORY_GLOBAL: l, CATEGORY_SPECIAL: v, options: a };
} });
var tl = I({ "src/main/support.js"(e, r) {
  "use strict";
  O();
  var u = { compare: jr(), lt: KD(), gte: JD() }, s = ZD(), D = el().version, n = ul().options;
  function i() {
    let { plugins: l = [], showUnreleased: v = false, showDeprecated: a = false, showInternal: c = false } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, p = D.split("-", 1)[0], g = l.flatMap((S) => S.languages || []).filter(m), C = s(Object.assign({}, ...l.map((S) => {
      let { options: N } = S;
      return N;
    }), n), "name").filter((S) => m(S) && B(S)).sort((S, N) => S.name === N.name ? 0 : S.name < N.name ? -1 : 1).map(w).map((S) => {
      S = Object.assign({}, S), Array.isArray(S.default) && (S.default = S.default.length === 1 ? S.default[0].value : S.default.filter(m).sort((b, M) => u.compare(M.since, b.since))[0].value), Array.isArray(S.choices) && (S.choices = S.choices.filter((b) => m(b) && B(b)), S.name === "parser" && f(S, g, l));
      let N = Object.fromEntries(l.filter((b) => b.defaultOptions && b.defaultOptions[S.name] !== void 0).map((b) => [b.name, b.defaultOptions[S.name]]));
      return Object.assign(Object.assign({}, S), {}, { pluginDefaults: N });
    });
    return { languages: g, options: C };
    function m(S) {
      return v || !("since" in S) || S.since && u.gte(p, S.since);
    }
    function B(S) {
      return a || !("deprecated" in S) || S.deprecated && u.lt(p, S.deprecated);
    }
    function w(S) {
      if (c)
        return S;
      let { cliName: N, cliCategory: b, cliDescription: M } = S;
      return ID(S, qD);
    }
  }
  function f(l, v, a) {
    let c = new Set(l.choices.map((p) => p.value));
    for (let p of v)
      if (p.parsers) {
        for (let g of p.parsers)
          if (!c.has(g)) {
            c.add(g);
            let C = a.find((B) => B.parsers && B.parsers[g]), m = p.name;
            C && C.name && (m += ` (plugin: ${C.name})`), l.choices.push({ value: g, description: m });
          }
      }
  }
  r.exports = { getSupportInfo: i };
} });
var nl = I({ "src/utils/is-non-empty-array.js"(e, r) {
  "use strict";
  O();
  function u(s) {
...
var il = ge({ "node_modules/strip-ansi/node_modules/ansi-regex/index.js"() {
  O();
} });
function al(e) {
  if (typeof e != "string")
...
var ol = ge({ "node_modules/strip-ansi/index.js"() {
  O(), il();
} });
function Dl(e) {
...
var ll = ge({ "node_modules/is-fullwidth-code-point/index.js"() {
  O();
} });
var cl = I({ "node_modules/emoji-regex/index.js"(e, r) {
  "use strict";
...
Yn(ts, { default: () => hl });
function hl(e) {
  if (typeof e != "string" || e.length === 0 || (e = al(e), e.length === 0))
    return 0;
  e = e.replace((0, ns.default)(), "  ");
  let r = 0;
  for (let u = 0; u < e.length; u++) {
    let s = e.codePointAt(u);
    s <= 31 || s >= 127 && s <= 159 || s >= 768 && s <= 879 || (s > 65535 && u++, r += Dl(s) ? 2 : 1);
  }
  return r;
}
var ns;
var pl = ge({ "node_modules/string-width/index.js"() {
  O(), ol(), ll(), ns = $D(cl());
} });
var fl = I({ "src/utils/get-string-width.js"(e, r) {
  "use strict";
  O();
  var u = (pl(), Kn(ts)).default, s = /[^\x20-\x7F]/;
  function D(n) {
    return n ? s.test(n) ? u(n) : n.length : 0;
  }
  r.exports = D;
} });
var Ur = I({ "src/utils/text/skip.js"(e, r) {
  "use strict";
  O();
  function u(f) {
    return (l, v, a) => {
...
var ss = I({ "src/utils/text/skip-inline-comment.js"(e, r) {
  "use strict";
  O();
  function u(s, D) {
    if (D === false)
...
var is = I({ "src/utils/text/skip-trailing-comment.js"(e, r) {
  "use strict";
  O();
...
var dl = I({ "src/utils/text/get-next-non-space-non-comment-character-index-with-start-index.js"(e, r) {
  "use strict";
  O();
  var u = ss(), s = as(), D = is(), { skipSpaces: n } = Ur();
  function i(f, l) {
    let v = null, a = l;
    for (; a !== v; )
      v = a, a = n(f, a), a = u(f, a), a = D(f, a), a = s(f, a);
    return a;
  }
  r.exports = i;
} });
var El = I({ "src/common/util.js"(e, r) {
  "use strict";
  O();
  var { default: u } = (HD(), Kn(es)), s = Zn(), { getSupportInfo: D } = tl(), n = nl(), i = fl(), { skipWhitespace: f, skipSpaces: l, skipToLineEnd: v, skipEverythingButNewLine: a } = Ur(), c = ss(), p = is(), g = as(), C = dl(), m = (_) => _[_.length - 2];
  function B(_) {
    return (E, A, y) => {
      let x = y && y.backwards;
      if (A === false)
  ...
  function w(_, E) {
    let A = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, y = l(_, A.backwards ? E - 1 : E, A), x = g(_, y, A);
    return y !== x;
  }
  function S(_, E, A) {
    for (let y = E; y < A; ++y)
...
`)
  ...
  function N(_, E, A) {
    let y = A(E) - 1;
    y = l(_, y, { backwards: true }), y = g(_, y, { backwards: true }), y = l(_, y, { backwards: true });
  ...
  function k(_, E) {
    ...
    return l(_, A.backwards ? E - 1 : E, A) !== E;
  }
  function j(_, E) {
  ...
  function L(_, E) {
    let A = _.lastIndexOf(`
`);
    return A === -1 ? 0 : j(_.slice(A + 1).match(/^[\t ]*/)[0], E);
  }
  function t(_, E) {
    let A = { quote: '"', regex: /"/g, escaped: "&quot;" }, y = { quote: "'", regex: /'/g, escaped: "&apos;" }, x = E === "'" ? y : A, $ = x === y ? A : y, V = x;
    if (_.includes(x.quote) || _.includes($.quote)) {
      let W = (_.match(x.regex) || []).length, Q = (_.match($.regex) || []).length;
      V = W > Q ? $ : x;
    }
    return V;
  }
  function o(_, E) {
    let A = _.slice(1, -1), y = E.parser === "json" || E.parser === "json5" && E.quoteProps === "preserve" && !E.singleQuote ? '"' : E.__isInHtmlAttribute ? "'" : t(A, E.singleQuote ? "'" : '"').quote;
    return d(A, y, !(E.parser === "css" || E.parser === "less" || E.parser === "scss" || E.__embeddedInHtml));
  }
  function d(_, E, A) {
    let y = E === '"' ? "'" : '"', x = /\\(.)|(["'])/gs, $ = _.replace(x, (V, W, Q) => W === y ? W : Q === E ? "\\" + Q : Q || (A && /^[^\n\r"'0-7\\bfnrt-vx\u2028\u2029]$/.test(W) ? W : "\\" + W));
    return E + $ + E;
  }
  function h(_) {
  ...
  function F(_, E) {
    let A = _.match(new RegExp(`(${u(E)})+`, "g"));
  ...
  function z(_, E) {
    let { languages: A } = D({ plugins: E.plugins }), y = A.find((x) => {
      let { name: $ } = x;
      return $.toLowerCase() === _;
    }) || A.find((x) => {
      let { aliases: $ } = x;
      return Array.isArray($) && $.includes(_);
    }) || A.find((x) => {
      let { extensions: $ } = x;
      return Array.isArray($) && $.includes(`.${_}`);
    });
...
var ml = I({ "src/language-html/utils/html-tag-names.js"(e, r) {
  "use strict";
  O();
  var { htmlTagNames: u } = Cl(), s = os(), D = s(u);
  r.exports = D;
} });
var gl = I({ "vendors/html-element-attributes.json"(e, r) {
...
var Fl = I({ "src/language-html/utils/map-object.js"(e, r) {
  "use strict";
  O();
  function u(s, D) {
    let n = /* @__PURE__ */ Object.create(null);
    for (let [i, f] of Object.entries(s))
      n[i] = D(f, i);
    return n;
  }
  r.exports = u;
} });
var Al = I({ "src/language-html/utils/html-elements-attributes.js"(e, r) {
  "use strict";
  O();
  var { htmlElementAttributes: u } = gl(), s = Fl(), D = os(), n = s(u, D);
  r.exports = n;
} });
var vl = I({ "src/language-html/utils/is-unknown-namespace.js"(e, r) {
  "use strict";
  O();
  function u(s) {
...
var _l = I({ "src/language-html/pragma.js"(e, r) {
  "use strict";
  O();
  function u(D) {
...
var Sl = I({ "src/language-html/ast.js"(e, r) {
  "use strict";
  O();
  var u = { attrs: true, children: true }, s = /* @__PURE__ */ new Set(["parent"]), D = class {
    constructor() {
      let i = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      for (let f of /* @__PURE__ */ new Set([...s, ...Object.keys(i)]))
        this.setProperty(f, i[f]);
    }
    setProperty(i, f) {
      if (this[i] !== f) {
        if (i in u && (f = f.map((l) => this.createChild(l))), !s.has(i)) {
          this[i] = f;
          return;
        }
    ...
    map(i) {
      ...
      for (let l in u) {
        ...
        if (v) {
          let a = n(v, (c) => c.map(i));
          f !== v && (f || (f = new D({ parent: this.parent })), f.setProperty(l, a));
        }
      }
      if (f)
        for (let l in this)
  ...
  function n(i, f) {
    let l = i.map(f);
    return l.some((v, a) => v !== i[a]) ? l : i;
  }
  r.exports = { Node: D };
} });
var yl = I({ "src/language-html/conditional-comment.js"(e, r) {
  "use strict";
  O();
  var { ParseSourceSpan: u } = be(), s = [{ regex: /^(\[if([^\]]*)]>)(.*?)<!\s*\[endif]$/s, parse: n }, { regex: /^\[if([^\]]*)]><!$/, parse: i }, { regex: /^<!\s*\[endif]$/, parse: f }];
  function D(l, v) {
    if (l.value)
      for (let { regex: a, parse: c } of s) {
        let p = l.value.match(a);
        if (p)
          return c(l, v, p);
      }
    return null;
  ...
  function n(l, v, a) {
    let [, c, p, g] = a, C = 4 + c.length, m = l.sourceSpan.start.moveBy(C), B = m.moveBy(g.length), [w, S] = (() => {
      try {
        return [true, v(g, m).children];
      } catch {
        let N = { type: "text", value: g, sourceSpan: new u(m, B) };
        return [false, [N]];
      }
    })();
    return { type: "ieConditionalComment", complete: w, children: S, condition: p.trim().replace(/\s+/g, " "), sourceSpan: l.sourceSpan, startSourceSpan: new u(l.sourceSpan.start, m), endSourceSpan: new u(B, l.sourceSpan.end) };
  }
  function i(l, v, a) {
    let [, c] = a;
...
var Tl = I({ "src/language-html/loc.js"(e, r) {
  "use strict";
  O();
  function u(D) {
...
var Je = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/tags.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r;
  (function(l) {
  ...
  function u(l) {
    ...
    return [l.slice(1, v), l.slice(v + 1)];
  }
  e.splitNsName = u;
  function s(l) {
...
var Ds = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/html_tags.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = Je(), u = class {
    constructor() {
      let { closedByChildren: i, implicitNamespacePrefix: f, contentType: l = r.TagContentType.PARSABLE_DATA, closedByParent: v = false, isVoid: a = false, ignoreFirstLf: c = false } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
      this.closedByChildren = {}, this.closedByParent = false, this.canSelfClose = false, i && i.length > 0 && i.forEach((p) => this.closedByChildren[p] = true), this.isVoid = a, this.closedByParent = v || a, this.implicitNamespacePrefix = f || null, this.contentType = l, this.ignoreFirstLf = c;
    }
    isClosedByChild(i) {
...
var Bl = I({ "node_modules/angular-html-parser/lib/compiler/src/ast_path.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = class {
    constructor(u) {
...
var ls = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/ast.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = Bl(), u = class {
    constructor(C, m, B) {
  ...
  var f = class {
    constructor(C, m, B, w) {
      let S = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : null, N = arguments.length > 5 && arguments[5] !== void 0 ? arguments[5] : null, b = arguments.length > 6 && arguments[6] !== void 0 ? arguments[6] : null, M = arguments.length > 7 && arguments[7] !== void 0 ? arguments[7] : null;
      this.name = C, this.attrs = m, this.children = B, this.sourceSpan = w, this.startSourceSpan = S, this.endSourceSpan = N, this.nameSpan = b, this.i18n = M, this.type = "element";
    }
    visit(C, m) {
  ...
  function g(C, m) {
    ...
    return a(w, C), new r.AstPath(B, m);
  }
  e.findNode = g;
} });
var bl = I({ "node_modules/angular-html-parser/lib/compiler/src/assertions.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  function r(D, n) {
    if (n != null) {
...
var wl = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/interpolation_config.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = bl(), u = class {
    constructor(s, D) {
...
var Nl = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/lexer.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = Jn(), u = be(), s = wl(), D = Je(), n;
  (function(t) {
...
`);
    ...
    tokenize() {
      ...
      return this._beginToken(n.EOF), this._endToken([]), new l(U(this.tokens), this.errors);
    }
    ...
    _endToken(t) {
      ...
      let d = new i(this._currentTokenType, t, this._cursor.getSpan(this._currentTokenStart, this._leadingTriviaCodePoints));
    ...
    handleError(t) {
      if (t instanceof L && (t = this._createError(t.msg, this._cursor.getSpan(t.cursor))), t instanceof g)
    ...
    _requireCharCodeUntilFn(t, o) {
      ...
      if (this._attemptCharCodeUntilFn(t), this._cursor.clone().diff(d) < o)
        throw this._createError(c(this._cursor.peek()), this._cursor.getSpan(d));
    }
    _attemptUntilChar(t) {
    ...
    _consumeTagOpen(t) {
      ...
      try {
        ...
        for (h = this._consumeTagOpenStart(t), d = h.parts[0], o = h.parts[1], this._attemptCharCodeUntilFn(m); this._cursor.peek() !== r.$SLASH && this._cursor.peek() !== r.$GT; ) {
        ...
        if (H instanceof g) {
          this._cursor = q, h && (this.tokens.length = F), this._beginToken(n.TEXT, t), this._endToken(["<"]);
          return;
        }
        throw H;
      }
    ...
    _consumeRawTextWithTagClose(t, o, d) {
      let h = this._consumeRawText(d, () => !this._attemptCharCode(r.$LT) || !this._attemptCharCode(r.$SLASH) || (this._attemptCharCodeUntilFn(m), !this._attemptStrCaseInsensitive(t ? `${t}:${o}` : o)) ? false : (this._attemptCharCodeUntilFn(m), this._attemptCharCode(r.$GT)));
    ...
    _consumeAttributeValue() {
      ...
      if (this._cursor.peek() === r.$SQ || this._cursor.peek() === r.$DQ) {
        ...
        t = this._processCarriageReturns(d.join("")), this._endToken([t]), this._beginToken(n.ATTR_QUOTE), this._cursor.advance(), this._endToken([String.fromCodePoint(o)]);
      } else {
...
var zn = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/parser.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = be(), u = ls(), s = Nl(), D = Je(), n = class extends r.ParseError {
    constructor(a, c, p) {
      super(c, p), this.elementName = a;
    }
    static create(a, c, p) {
      return new n(a, c, p);
    }
  ...
  var f = class {
    ...
    parse(a, c, p) {
      let g = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false, C = arguments.length > 4 ? arguments[4] : void 0, m = (k) => function(j) {
        for (var L = arguments.length, t = new Array(L > 1 ? L - 1 : 0), o = 1; o < L; o++)
          t[o - 1] = arguments[o];
        return k(j.toLowerCase(), ...t);
      }, B = g ? this.getTagDefinition : m(this.getTagDefinition), w = (k) => B(k).contentType, S = g ? C : m(C), N = C ? (k, j, L, t) => {
        let o = S(k, j, L, t);
        return o !== void 0 ? o : w(k);
      } : w, b = s.tokenize(a, c, N, p), M = p && p.canSelfClose || false, R = p && p.allowHtmComponentClosingTags || false, U = new l(b.tokens, B, M, R, g).build();
      return new i(U.rootNodes, b.errors.concat(U.errors));
    }
  };
  e.Parser = f;
  var l = class {
    constructor(a, c, p, g, C) {
      this.tokens = a, this.getTagDefinition = c, this.canSelfClose = p, this.allowHtmComponentClosingTags = g, this.isTagNameCaseSensitive = C, this._index = -1, this._rootNodes = [], this._errors = [], this._elementStack = [], this._advance();
    }
    build() {
    ...
    _consumeCdata(a) {
      let c = this._advance(), p = this._getText(c), g = this._advanceIf(s.TokenType.CDATA_END);
      this._addToParent(new u.CDATA(p, new r.ParseSourceSpan(a.sourceSpan.start, (g || c).sourceSpan.end)));
    }
    _consumeComment(a) {
      let c = this._advanceIf(s.TokenType.RAW_TEXT), p = this._advanceIf(s.TokenType.COMMENT_END), g = c != null ? c.parts[0].trim() : null, C = new r.ParseSourceSpan(a.sourceSpan.start, (p || c || a).sourceSpan.end);
      this._addToParent(new u.Comment(g, C));
    }
    _consumeDocType(a) {
      let c = this._advanceIf(s.TokenType.RAW_TEXT), p = this._advanceIf(s.TokenType.DOC_TYPE_END), g = c != null ? c.parts[0].trim() : null, C = new r.ParseSourceSpan(a.sourceSpan.start, (p || c || a).sourceSpan.end);
      this._addToParent(new u.DocType(g, C));
    }
    _consumeExpansion(a) {
      let c = this._advance(), p = this._advance(), g = [];
      ...
      let C = new r.ParseSourceSpan(a.sourceSpan.start, this._peek.sourceSpan.end);
      this._addToParent(new u.Expansion(c.parts[0], p.parts[0], g, C, c.sourceSpan)), this._advance();
    }
    _parseExpansionCase() {
      let a = this._advance();
      ...
      let c = this._advance(), p = this._collectExpansionExpTokens(c);
      if (!p)
        return null;
      let g = this._advance();
      p.push(new s.Token(s.TokenType.EOF, [], g.sourceSpan));
      let C = new l(p, this.getTagDefinition, this.canSelfClose, this.allowHtmComponentClosingTags, this.isTagNameCaseSensitive).build();
      if (C.errors.length > 0)
        return this._errors = this._errors.concat(C.errors), null;
      let m = new r.ParseSourceSpan(a.sourceSpan.start, g.sourceSpan.end), B = new r.ParseSourceSpan(c.sourceSpan.start, g.sourceSpan.end);
      return new u.ExpansionCase(a.parts[0], C.rootNodes, m, a.sourceSpan, B);
    }
    _collectExpansionExpTokens(a) {
      let c = [], p = [s.TokenType.EXPANSION_CASE_EXP_START];
      for (; ; ) {
...
`) {
        ...
        p != null && p.children.length == 0 && this.getTagDefinition(p.name).ignoreFirstLf && (c = c.substring(1));
      }
      return c;
    }
    _consumeText(a) {
    ...
    _consumeStartTag(a) {
      let c = a.parts[0], p = a.parts[1], g = [];
      for (; this._peek.type === s.TokenType.ATTR_NAME; )
        g.push(this._consumeAttr(this._advance()));
      let C = this._getElementFullName(c, p, this._getParentElement()), m = false;
      if (this._peek.type === s.TokenType.TAG_OPEN_END_VOID) {
        this._advance(), m = true;
        let b = this.getTagDefinition(C);
        this.canSelfClose || b.canSelfClose || D.getNsPrefix(C) !== null || b.isVoid || this._errors.push(n.create(C, a.sourceSpan, `Only void and foreign elements can be self closed "${a.parts[1]}"`));
      } else
        this._peek.type === s.TokenType.TAG_OPEN_END && (this._advance(), m = false);
      let B = this._peek.sourceSpan.start, w = new r.ParseSourceSpan(a.sourceSpan.start, B), S = new r.ParseSourceSpan(a.sourceSpan.start.moveBy(1), a.sourceSpan.end), N = new u.Element(C, g, [], w, w, void 0, S);
    ...
    _consumeEndTag(a) {
      ...
      if (this._getParentElement() && (this._getParentElement().endSourceSpan = a.sourceSpan), c && this.getTagDefinition(c).isVoid)
        ...
        let p = `Unexpected closing tag "${c}". It may happen when the tag has already been closed by another tag. For more info see https://www.w3.org/TR/html5/syntax.html#closing-elements-that-have-implied-end-tags`;
        this._errors.push(n.create(c, a.sourceSpan, p));
      }
    }
    _popElement(a) {
      for (let c = this._elementStack.length - 1; c >= 0; c--) {
        let p = this._elementStack[c];
        if (!a || (D.getNsPrefix(p.name) ? p.name == a : p.name.toLowerCase() == a.toLowerCase()))
    ...
    _consumeAttr(a) {
      let c = D.mergeNsAndName(a.parts[0], a.parts[1]), p = a.sourceSpan.end, g = "", C, m;
      ...
      return this._peek.type === s.TokenType.ATTR_QUOTE && (p = this._advance().sourceSpan.end, C = new r.ParseSourceSpan(m, p)), new u.Attribute(c, g, new r.ParseSourceSpan(a.sourceSpan.start, p), C, a.sourceSpan);
    }
    _getParentElement() {
    ...
    _insertBeforeContainer(a, c, p) {
      if (!c)
        this._addToParent(p), this._elementStack.push(p);
      else {
        if (a) {
          let g = a.children.indexOf(c);
          a.children[g] = p;
        } else
          this._rootNodes.push(p);
        p.children.push(c), this._elementStack.splice(this._elementStack.indexOf(c), 0, p);
      }
    }
    _getElementFullName(a, c, p) {
      return a === "" && (a = this.getTagDefinition(c).implicitNamespacePrefix || "", a === "" && p != null && (a = D.getNsPrefix(p.name))), D.mergeNsAndName(a, c);
    }
  };
  function v(a, c) {
...
var Ol = I({ "node_modules/angular-html-parser/lib/compiler/src/ml_parser/html_parser.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = Ds(), u = zn(), s = zn();
  ...
  var D = class extends u.Parser {
    ...
    parse(n, i, f) {
      let l = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : false, v = arguments.length > 4 ? arguments[4] : void 0;
      return super.parse(n, i, f, l, v);
    }
  };
  e.HtmlParser = D;
} });
var Wn = I({ "node_modules/angular-html-parser/lib/angular-html-parser/src/index.js"(e) {
  "use strict";
  O(), Object.defineProperty(e, "__esModule", { value: true });
  var r = Ol(), u = Je();
  ...
  function n(i) {
    let f = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : {}, { canSelfClose: l = false, allowHtmComponentClosingTags: v = false, isTagNameCaseSensitive: a = false, getTagContentType: c } = f;
    return D().parse(i, "angular-html-parser", { tokenizeExpansionForms: false, interpolationConfig: void 0, canSelfClose: l, allowHtmComponentClosingTags: v }, a, c);
  }
  e.parse = n;
} });
var ql = I({ "src/language-html/parser-html.js"(e, r) {
  O();
  var { ParseSourceSpan: u, ParseLocation: s, ParseSourceFile: D } = be(), n = GD(), i = Zn(), f = VD(), { inferParserByLanguage: l } = El(), v = ml(), a = Al(), c = vl(), { hasPragma: p } = _l(), { Node: g } = Sl(), { parseIeConditionalComment: C } = yl(), { locStart: m, locEnd: B } = Tl();
  function w(b, M, R) {
    let { recognizeSelfClosing: U, normalizeTagName: k, normalizeAttributeName: j, allowHtmComponentClosingTags: L, isTagNameCaseSensitive: t, getTagContentType: o } = M, d = Wn(), { RecursiveVisitor: h, visitAll: F } = ls(), { ParseSourceSpan: q } = be(), { getHtmlTagDefinition: P } = Ds(), { rootNodes: G, errors: H } = d.parse(b, { canSelfClose: U, allowHtmComponentClosingTags: L, isTagNameCaseSensitive: t, getTagContentType: o });
    if (R.parser === "vue")
      if (G.some((A) => A.type === "docType" && A.value === "html" || A.type === "element" && A.name.toLowerCase() === "html")) {
        U = true, k = true, j = true, L = true, t = false;
        let A = d.parse(b, { canSelfClose: U, allowHtmComponentClosingTags: L, isTagNameCaseSensitive: t });
        G = A.rootNodes, H = A.errors;
      } else {
        let A = (y) => {
          if (!y || y.type !== "element" || y.name !== "template")
            return false;
          let x = y.attrs.find((V) => V.name === "lang"), $ = x && x.value;
          return !$ || l($, R) === "html";
        };
        if (G.some(A)) {
          let y, x = () => d.parse(b, { canSelfClose: U, allowHtmComponentClosingTags: L, isTagNameCaseSensitive: t }), $ = () => y || (y = x()), V = (W) => $().rootNodes.find((Q) => {
    ...
    let K = (E) => {
      let A = E.name.startsWith(":") ? E.name.slice(1).split(":")[0] : null, y = E.nameSpan.toString(), x = A !== null && y.startsWith(`${A}:`), $ = x ? y.slice(A.length + 1) : y;
      E.name = $, E.namespace = A, E.hasExplicitNamespace = x;
    }, z = (E) => {
      switch (E.type) {
        case "element":
          K(E);
      ...
      if (E.type === "element" && (k && (!E.namespace || E.namespace === E.tagDefinition.implicitNamespacePrefix || c(E)) && (E.name = Y(E.name, (A) => A in v)), j)) {
        let A = a[E.name] || /* @__PURE__ */ Object.create(null);
        for (let y of E.attrs)
          y.namespace || (y.name = Y(y.name, (x) => E.name in a && (x in a["*"] || x in A)));
      }
    }, Z = (E) => {
      E.sourceSpan && E.endSourceSpan && (E.sourceSpan = new q(E.sourceSpan.start, E.endSourceSpan.end));
    }, _ = (E) => {
      if (E.type === "element") {
        let A = P(t ? E.name : E.name.toLowerCase());
        !E.namespace || E.namespace === A.implicitNamespacePrefix || c(E) ? E.tagDefinition = A : E.tagDefinition = P("");
      }
    };
  ...
  function S(b, M, R) {
    let U = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : true, { frontMatter: k, content: j } = U ? n(b) : { frontMatter: null, content: b }, L = new D(b, M.filepath), t = new s(L, 0, 0, 0), o = t.moveBy(b.length), d = { type: "root", sourceSpan: new u(t, o), children: w(j, R, M) };
    if (k) {
      let q = new s(L, 0, 0, 0), P = q.moveBy(k.raw.length);
      k.sourceSpan = new u(q, P), d.children.unshift(k);
    }
    let h = new g(d), F = (q, P) => {
      let { offset: G } = P, H = b.slice(0, G).replace(/[^\n\r]/g, " "), z = S(H + q, M, R, false);
      z.sourceSpan = new u(P, i(z.children).sourceSpan.end);
      let Y = z.children[0];
      return Y.length === G ? z.children.shift() : (Y.sourceSpan = new u(Y.sourceSpan.start.moveBy(G), Y.sourceSpan.end), Y.value = Y.value.slice(G)), z;
    };
    return h.walk((q) => {
      if (q.type === "comment") {
        let P = C(q, F);
  ...
  function N() {
    let { name: b, recognizeSelfClosing: M = false, normalizeTagName: R = false, normalizeAttributeName: U = false, allowHtmComponentClosingTags: k = false, isTagNameCaseSensitive: j = false, getTagContentType: L } = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {};
    return { parse: (t, o, d) => S(t, Object.assign({ parser: b }, d), { recognizeSelfClosing: M, normalizeTagName: R, normalizeAttributeName: U, allowHtmComponentClosingTags: k, isTagNameCaseSensitive: j, getTagContentType: L }), hasPragma: p, astFormat: "html", locStart: m, locEnd: B };
  }
  r.exports = { parsers: { html: N({ name: "html", recognizeSelfClosing: true, normalizeTagName: true, normalizeAttributeName: true, allowHtmComponentClosingTags: true }), angular: N({ name: "angular" }), vue: N({ name: "vue", recognizeSelfClosing: true, isTagNameCaseSensitive: true, getTagContentType: (b, M, R, U) => {
    if (b.toLowerCase() !== "html" && !R && (b !== "template" || U.some((k) => {
      let { name: j, value: L } = k;
      return j === "lang" && L !== "html" && L !== "" && L !== void 0;
    })))
      return Wn().TagContentType.RAW_TEXT;
  } }), lwc: N({ name: "lwc" }) } };
} });
var o2 = ql();
export {
